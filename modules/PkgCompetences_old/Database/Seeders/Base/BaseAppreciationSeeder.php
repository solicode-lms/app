...
class BaseAppreciationSeeder extends Seeder
{
    ...
    {
        $csvFile = fopen(base_path("modules/PkgCompetences/Database/data/appreciations.csv"), "r");
        $firstline = true;
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'AppreciationController';
        $controllerBaseName = 'appreciation';
        $domainName = 'Appreciation';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Édition ' => [ 'create','store','edit','update','destroy','getAppreciations'],
            'Lecture' => ['index', 'show'],
