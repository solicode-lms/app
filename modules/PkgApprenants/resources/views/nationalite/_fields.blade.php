...
<form 
    ...
    @if ($itemNationalite->id)
        <input type="hidden" name="id" value="{{ $itemNationalite->id }}">
        @method('PUT')
    @endif
    @if ($bulkEdit && !empty($nationalite_ids))
    ...
    <div class="row">
        <x-form-field :defined_vars="get_defined_vars()" :entity="$itemNationalite" field="code" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemNationalite" field="nom" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemNationalite" field="description" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-12">
          ...
          <label for="description">
            {{ ucfirst(__('PkgApprenants::nationalite.description')) }}
                ...
                id="description">
                {!! \App\Helpers\TextHelper::sanitizeTextarea(old('description', $itemNationalite->description ?? '')) !!}
                </textarea>
          @error('description')
            <div class="text-danger">{{ $message }}</div>
          @enderror
