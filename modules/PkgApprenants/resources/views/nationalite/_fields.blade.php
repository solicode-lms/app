...
<form 
    ...
    <div class="row">
        <x-form-field :entity="$itemNationalite" field="code" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemNationalite" field="nom" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemNationalite" field="description" :bulkEdit="$bulkEdit">
