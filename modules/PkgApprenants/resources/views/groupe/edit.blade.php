            ...
            <div class="row">
                ...
                <div id="card-tab-groupe" class="card card-info card-tabs card-workflow">
                    <div class="card-header d-flex justify-content-between p-0 pt-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="groupe-hasmany-tabs-apprenant-tab" data-toggle="pill" href="#groupe-hasmany-tabs-apprenant" role="tab" aria-controls="groupe-hasmany-tabs-apprenant" aria-selected="false">{{__('PkgApprenants::apprenant.plural')}}</a>
                        </li>
