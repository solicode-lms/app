...
<form 
    ...
    <div class="row">
        <x-form-field :entity="$itemNiveauxScolaire" field="code">
...
<x-form-field :entity="$itemNiveauxScolaire" field="nom">
...
<x-form-field :entity="$itemNiveauxScolaire" field="description">
