            ...
            <div class="row">
                ...
                <div id="card-tab-niveauxScolaire" class="card card-info card-tabs card-workflow">
                    <div class="card-header d-flex justify-content-between p-0 pt-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="niveauxScolaire-hasmany-tabs-apprenant-tab" data-toggle="pill" href="#niveauxScolaire-hasmany-tabs-apprenant" role="tab" aria-controls="niveauxScolaire-hasmany-tabs-apprenant" aria-selected="false">{{ucfirst(__('PkgApprenants::apprenant.plural'))}}</a>
                        </li>
