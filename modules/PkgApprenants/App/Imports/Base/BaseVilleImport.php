...
class BaseVilleImport implements ToModel, WithHeadingRow
{
    /**
     ...
     * @return Ville|null
     */
    private function findExistingRecord($reference): ?Ville
    {
        if($reference == null) return null;
        return Ville::where('reference', $reference)->first();
    }
