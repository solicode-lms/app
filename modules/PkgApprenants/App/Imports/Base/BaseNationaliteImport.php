...
class BaseNationaliteImport implements ToModel, WithHeadingRow
{
    /**
     ...
     */
    private function findExistingRecord($reference): ?Nationalite
    {
        if($reference == null) return null;
        return Nationalite::where('reference', $reference)->first();
    }
