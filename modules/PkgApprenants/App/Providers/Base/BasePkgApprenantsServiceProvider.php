...
namespace Modules\PkgApprenants\App\Providers\Base;
...
class BasePkgApprenantsServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgApprenants');
    ...
    protected function registerObservers()
    {
        ...
        $namespace = 'Modules\\PkgApprenants\\Observers\\';
        $modelNamespace = 'Modules\\PkgApprenants\\Models\\';
