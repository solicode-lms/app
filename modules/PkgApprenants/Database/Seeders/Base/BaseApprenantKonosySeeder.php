    ...
    public function seedFromCsv(): void
    {
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $apprenantKonosyData =[
                        "MatriculeEtudiant" => $row["MatriculeEtudiant"] === "" ? null : $row["MatriculeEtudiant"],
                        "Nom" => $row["Nom"] === "" ? null : $row["Nom"],
                        "Prenom" => $row["Prenom"] === "" ? null : $row["Prenom"],
                        "Sexe" => $row["Sexe"] === "" ? null : $row["Sexe"],
                        "EtudiantActif" => $row["EtudiantActif"] === "" ? null : $row["EtudiantActif"],
                        "Diplome" => $row["Diplome"] === "" ? null : $row["Diplome"],
                        "Principale" => $row["Principale"] === "" ? null : $row["Principale"],
                        "LibelleLong" => $row["LibelleLong"] === "" ? null : $row["LibelleLong"],
                        "CodeDiplome" => $row["CodeDiplome"] === "" ? null : $row["CodeDiplome"],
                        "DateNaissance" => $row["DateNaissance"] === "" ? null : $row["DateNaissance"],
                        "DateInscription" => $row["DateInscription"] === "" ? null : $row["DateInscription"],
                        "LieuNaissance" => $row["LieuNaissance"] === "" ? null : $row["LieuNaissance"],
                        "CIN" => $row["CIN"] === "" ? null : $row["CIN"],
                        "NTelephone" => $row["NTelephone"] === "" ? null : $row["NTelephone"],
                        "Adresse" => $row["Adresse"] === "" ? null : $row["Adresse"],
                        "Nationalite" => $row["Nationalite"] === "" ? null : $row["Nationalite"],
                        "Nom_Arabe" => $row["Nom_Arabe"] === "" ? null : $row["Nom_Arabe"],
                        "Prenom_Arabe" => $row["Prenom_Arabe"] === "" ? null : $row["Prenom_Arabe"],
                        "NiveauScolaire" => $row["NiveauScolaire"] === "" ? null : $row["NiveauScolaire"],
