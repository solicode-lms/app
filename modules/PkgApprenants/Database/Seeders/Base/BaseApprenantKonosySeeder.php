    ...
    public function seedFromCsv(): void
    {
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $apprenantKonosyData =[
                        "MatriculeEtudiant" => isset($row["MatriculeEtudiant"]) && $row["MatriculeEtudiant"] !== "" ? $row["MatriculeEtudiant"] : null,
                        "Nom" => isset($row["Nom"]) && $row["Nom"] !== "" ? $row["Nom"] : null,
                        "Prenom" => isset($row["Prenom"]) && $row["Prenom"] !== "" ? $row["Prenom"] : null,
                        "Sexe" => isset($row["Sexe"]) && $row["Sexe"] !== "" ? $row["Sexe"] : null,
                        "EtudiantActif" => isset($row["EtudiantActif"]) && $row["EtudiantActif"] !== "" ? $row["EtudiantActif"] : null,
                        "Diplome" => isset($row["Diplome"]) && $row["Diplome"] !== "" ? $row["Diplome"] : null,
                        "Principale" => isset($row["Principale"]) && $row["Principale"] !== "" ? $row["Principale"] : null,
                        "LibelleLong" => isset($row["LibelleLong"]) && $row["LibelleLong"] !== "" ? $row["LibelleLong"] : null,
                        "CodeDiplome" => isset($row["CodeDiplome"]) && $row["CodeDiplome"] !== "" ? $row["CodeDiplome"] : null,
                        "DateNaissance" => isset($row["DateNaissance"]) && $row["DateNaissance"] !== "" ? $row["DateNaissance"] : null,
                        "DateInscription" => isset($row["DateInscription"]) && $row["DateInscription"] !== "" ? $row["DateInscription"] : null,
                        "LieuNaissance" => isset($row["LieuNaissance"]) && $row["LieuNaissance"] !== "" ? $row["LieuNaissance"] : null,
                        "CIN" => isset($row["CIN"]) && $row["CIN"] !== "" ? $row["CIN"] : null,
                        "NTelephone" => isset($row["NTelephone"]) && $row["NTelephone"] !== "" ? $row["NTelephone"] : null,
                        "Adresse" => isset($row["Adresse"]) && $row["Adresse"] !== "" ? $row["Adresse"] : null,
                        "Nationalite" => isset($row["Nationalite"]) && $row["Nationalite"] !== "" ? $row["Nationalite"] : null,
                        "Nom_Arabe" => isset($row["Nom_Arabe"]) && $row["Nom_Arabe"] !== "" ? $row["Nom_Arabe"] : null,
                        "Prenom_Arabe" => isset($row["Prenom_Arabe"]) && $row["Prenom_Arabe"] !== "" ? $row["Prenom_Arabe"] : null,
