        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $apprenantData =[
                        ...
                        "nom_arab" => !empty($row["nom_arab"]) ? $row["nom_arab"] : null,
                        "prenom" => !empty($row["prenom"]) ? $row["prenom"] : null,
                        "prenom_arab" => !empty($row["prenom_arab"]) ? $row["prenom_arab"] : null,
                        ...
                        "lieu_naissance" => !empty($row["lieu_naissance"]) ? $row["lieu_naissance"] : null,
                        ...
                        "tele_num" => !empty($row["tele_num"]) ? $row["tele_num"] : null,
                        "user_id" => $user_id,
                        "matricule" => !empty($row["matricule"]) ? $row["matricule"] : null,
                        "date_inscription" => !empty($row["date_inscription"]) ? $row["date_inscription"] : null,
                        "actif" => !empty($row["actif"]) ? $row["actif"] : null,
