        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $apprenantData =[
                        ...
                        "date_naissance" => isset($row["date_naissance"]) && $row["date_naissance"] !== "" ? $row["date_naissance"] : null,
                        "sexe" => isset($row["sexe"]) && $row["sexe"] !== "" ? $row["sexe"] : null,
                        "nationalite_id" => $nationalite_id,
                        "lieu_naissance" => isset($row["lieu_naissance"]) && $row["lieu_naissance"] !== "" ? $row["lieu_naissance"] : null,
                        ...
                        "date_inscription" => isset($row["date_inscription"]) && $row["date_inscription"] !== "" ? $row["date_inscription"] : null,
