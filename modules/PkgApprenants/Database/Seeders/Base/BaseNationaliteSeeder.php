...
class BaseNationaliteSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgApprenants/Database/data/nationalites.csv");
        ...
        $nationaliteService = new NationaliteService();
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $nationalite = $nationaliteService->updateOrCreate(["reference" => $row["reference"]], $nationaliteData);
                } else {
                    $nationalite = $nationaliteService->create($nationaliteData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'NationaliteController';
        $controllerBaseName = 'nationalite';
        $domainName = 'Nationalite';
