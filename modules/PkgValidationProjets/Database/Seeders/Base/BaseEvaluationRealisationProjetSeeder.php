...
namespace Modules\PkgValidationProjets\Database\Seeders\Base;
...
class BaseEvaluationRealisationProjetSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgValidationProjets/Database/data/evaluationRealisationProjets.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $moduleSlug = 'PkgValidationProjets'; // Slug du module
        ...
        $controllerName = 'EvaluationRealisationProjetController';
        $controllerBaseName = 'evaluationRealisationProjet';
        $domainName = 'EvaluationRealisationProjet';
