...
class BaseEvaluateurSeeder extends Seeder
{
    public static int $order = 67;
    ...
    {
        $filePath = base_path("modules/PkgValidationProjets/Database/data/evaluateurs.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'EvaluateurController';
        $controllerBaseName = 'evaluateur';
        $domainName = 'Evaluateur';
