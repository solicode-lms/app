...
use Modules\PkgValidationProjets\App\Requests\EtatEvaluationProjetRequest;
use Modules\PkgValidationProjets\Models\EtatEvaluationProjet;
use Maatwebsite\Excel\Facades\Excel;
use Modules\PkgValidationProjets\App\Exports\EtatEvaluationProjetExport;
use Modules\PkgValidationProjets\App\Imports\EtatEvaluationProjetImport;
...
class BaseEtatEvaluationProjetController extends AdminController
{
    ...
    public function index(Request $request) {
        ...
        if ($request->ajax()) {
            if($request['showIndex']){
                return view('PkgValidationProjets::etatEvaluationProjet._index', $etatEvaluationProjet_compact_value)->render();
            }else{
                return view($etatEvaluationProjet_partialViewName, $etatEvaluationProjet_compact_value)->render();
            }
        }

        return view('PkgValidationProjets::etatEvaluationProjet.index', $etatEvaluationProjet_compact_value);
    }
    /**
     */
    ...
    public function bulkEditForm(Request $request) {
        ...
        if (request()->ajax()) {
            return view('PkgValidationProjets::etatEvaluationProjet._fields', compact('bulkEdit', 'etatEvaluationProjet_ids', 'itemEtatEvaluationProjet', 'sysColors'));
        }
        return view('PkgValidationProjets::etatEvaluationProjet.bulk-edit', compact('bulkEdit', 'etatEvaluationProjet_ids', 'itemEtatEvaluationProjet', 'sysColors'));
    }
    /**
     */
    public function store(EtatEvaluationProjetRequest $request) {
        ...
        if ($request->ajax()) {
             $message = __('Core::msg.addSuccess', [
                ...
                'modelName' => __('PkgValidationProjets::etatEvaluationProjet.singular')]);
    ...
    public function show(string $id) {
        ...
        if (request()->ajax()) {
            return view('PkgValidationProjets::etatEvaluationProjet._show', array_merge(compact('itemEtatEvaluationProjet'),$evaluationRealisationProjet_compact_value));
        }

        return view('PkgValidationProjets::etatEvaluationProjet.show', array_merge(compact('itemEtatEvaluationProjet'),$evaluationRealisationProjet_compact_value));
    ...
    public function bulkDelete(Request $request) {
        ...
        return JsonResponseHelper::success(__('Core::msg.deleteSuccess', [
            ...
            'modelName' => __('PkgValidationProjets::etatEvaluationProjet.plural')
        ]));
    }
    ...
    public function import(Request $request)
    {
        ...
        return redirect()->route('etatEvaluationProjets.index')->with(
            ...
            'modelNames' =>  __('PkgValidationProjets::etatEvaluationProjet.plural')
            ]));
