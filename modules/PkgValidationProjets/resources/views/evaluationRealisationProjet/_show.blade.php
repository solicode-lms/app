...
<div id="evaluationRealisationProjet-crud-show">
        <div class="card-body">
          ...
          <div class="border rounded p-2 h-100">
                        <small class="text-muted d-block">{{ ucfirst(__('PkgValidationProjets::evaluationRealisationProjet.date_evaluation')) }}</small>
  ...
  @endif
      ...
      <div class="col-12 col-md-6 col-lg-6 mb-3 px-2">
          <div class="border rounded p-2 h-100">
                        <small class="text-muted d-block">{{ ucfirst(__('PkgValidationProjets::etatEvaluationProjet.singular')) }}</small>
      ...
      <div class="col-12 col-md-6 mb-3 px-2 show-has-many">
          <div class="border rounded p-2 h-100 " >
            ...
            <div class="pt-2">
                  @include('PkgValidationProjets::evaluationRealisationTache._index',['isMany' => true, "edit_has_many" => false,"contextKey" => 'evaluationRealisationProjet.show_' . $itemEvaluationRealisationProjet->id])
            </div>
          </div>
      </div>
