...
<div id="etatEvaluationProjet-crud-show">
        <div class="card-body">
          ...
          <div class="border rounded p-2 h-100">
                        <small class="text-muted d-block">{{ ucfirst(__('PkgValidationProjets::etatEvaluationProjet.ordre')) }}</small>
      ...
      <div class="col-12 col-md-6 col-lg-6 mb-3 px-2">
          <div class="border rounded p-2 h-100">
                        <small class="text-muted d-block">{{ ucfirst(__('PkgValidationProjets::etatEvaluationProjet.code')) }}</small>
                                <!-- Valeur texte -->
      ...
      <div class="col-12 col-md-6 col-lg-6 mb-3 px-2">
          <div class="border rounded p-2 h-100">
                        <small class="text-muted d-block">{{ ucfirst(__('PkgValidationProjets::etatEvaluationProjet.titre')) }}</small>
                                <!-- Valeur texte -->
      ...
      <div class="col-12 col-md-12 col-lg-12 mb-3 px-2">
          <div class="border rounded p-2 h-100">
                        <small class="text-muted d-block">{{ ucfirst(__('PkgValidationProjets::etatEvaluationProjet.description')) }}</small>
  ...
  @endif
      ...
      <div class="col-12 col-md-6 mb-3 px-2 show-has-many">
          <div class="border rounded p-2 h-100 " >
            ...
            <div class="pt-2">
                  @include('PkgValidationProjets::evaluationRealisationProjet._index',['isMany' => true, "edit_has_many" => false,"contextKey" => 'etatEvaluationProjet.show_' . $itemEtatEvaluationProjet->id])
            </div>
          </div>
      </div>
