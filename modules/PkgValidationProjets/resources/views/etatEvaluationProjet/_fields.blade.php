...
<form 
    ...
    @if ($itemEtatEvaluationProjet->id)
        @method('PUT')
    @endif
    @if (!empty($bulkEdit) && !empty($etatEvaluationProjet_ids))
    ...
    <div class="row">
        <x-form-field :entity="$itemEtatEvaluationProjet" field="ordre" bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          @endif
          <label for="ordre">
            {{ ucfirst(__('PkgValidationProjets::etatEvaluationProjet.ordre')) }}
            <span class="text-danger">*</span>
                ...
                id="ordre"
                placeholder="{{ __('PkgValidationProjets::etatEvaluationProjet.ordre') }}"
...
<x-form-field :entity="$itemEtatEvaluationProjet" field="code" bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          @endif
          <label for="code">
            {{ ucfirst(__('PkgValidationProjets::etatEvaluationProjet.code')) }}
            <span class="text-danger">*</span>
          </label>
           <input
                name="code"
                ...
                id="code"
                placeholder="{{ __('PkgValidationProjets::etatEvaluationProjet.code') }}"
...
<x-form-field :entity="$itemEtatEvaluationProjet" field="titre" bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          @endif
          <label for="titre">
            {{ ucfirst(__('PkgValidationProjets::etatEvaluationProjet.titre')) }}
            <span class="text-danger">*</span>
          </label>
           <input
                name="titre"
                ...
                id="titre"
                placeholder="{{ __('PkgValidationProjets::etatEvaluationProjet.titre') }}"
...
<x-form-field :entity="$itemEtatEvaluationProjet" field="description" bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-12">
          ...
          <label for="description">
            {{ ucfirst(__('PkgValidationProjets::etatEvaluationProjet.description')) }}
                ...
                id="description"
                placeholder="{{ __('PkgValidationProjets::etatEvaluationProjet.description') }}">{{ $itemEtatEvaluationProjet ? $itemEtatEvaluationProjet->description : old('description') }}</textarea>
          @error('description')
            <div class="text-danger">{{ $message }}</div>
          @enderror
      </div>
...
<x-form-field :entity="$itemEtatEvaluationProjet" field="sys_color_id" bulkEdit="$bulkEdit">
...
<script>
    ...
    @if (!empty($bulkEdit))
        window.modalTitle = '{{__("PkgValidationProjets::etatEvaluationProjet.singular") }} : {{__("Core::msg.edition_en_masse") }}'
    @else
        window.modalTitle = '{{__("PkgValidationProjets::etatEvaluationProjet.singular") }} : {{$itemEtatEvaluationProjet}}'
    @endif
