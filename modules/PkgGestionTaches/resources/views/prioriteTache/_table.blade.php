    ...
    <table class="table table-striped text-nowrap" style="table-layout: fixed; width: 100%;">
        <thead style="width: 100%">
            <tr>
                ...
                <x-sortable-column :sortable="true" width="5"  field="ordre" modelname="prioriteTache" label="{{ucfirst(__('PkgRealisationTache::prioriteTache.ordre'))}}" />
                <x-sortable-column :sortable="true" width="38.5"  field="nom" modelname="prioriteTache" label="{{ucfirst(__('PkgRealisationTache::prioriteTache.nom'))}}" />
