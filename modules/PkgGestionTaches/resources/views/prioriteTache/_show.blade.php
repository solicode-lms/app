...
<div id="prioriteTache-crud-show">
        <div class="card-body">
          ...
          <div class="border rounded p-2 h-100">
                        <small class="text-muted d-block">{{ ucfirst(__('PkgGestionTaches::prioriteTache.ordre')) }}</small>
      ...
      <div class="col-12 col-md-6 col-lg-6 mb-3 px-2">
          <div class="border rounded p-2 h-100">
                        <small class="text-muted d-block">{{ ucfirst(__('PkgGestionTaches::prioriteTache.nom')) }}</small>
                                <!-- Valeur texte -->
      ...
      <div class="col-12 col-md-12 col-lg-12 mb-3 px-2">
          <div class="border rounded p-2 h-100">
                        <small class="text-muted d-block">{{ ucfirst(__('PkgGestionTaches::prioriteTache.description')) }}</small>
