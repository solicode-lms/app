...
<div id="etatRealisationTache-crud" class="crud">
    ...
    @endphp
    <x-crud-header 
        id="etatRealisationTache-crud-header" icon="fas fa-hourglass-half"  
        iconColor="text-info"
        title="{{ __('PkgGestionTaches::etatRealisationTache.plural') }}"
        :breadcrumbs="[
            ['label' => $package, 'url' => '#'],
            ['label' => $titre]
        ]"
        ...
        <div class="container-fluid">
            <div class="card card-outline card-info " id="card_crud">
                ...
                <div id="etatRealisationTache-data-container" class="data-container">
                    @include('PkgGestionTaches::etatRealisationTache._table')
                </div>
            </div>
        </div>
    </section>
