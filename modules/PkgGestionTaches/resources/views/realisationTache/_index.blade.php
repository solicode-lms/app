...
<div id="realisationTache-crud" class="crud">
    ...
    @endphp
    <x-crud-header 
        id="realisationTache-crud-header" icon="fas fa-tasks"  
        iconColor="text-info"
        ...
        <div class="container-fluid">
            <div class="card card-outline card-info " id="card_crud">
                ...
                <div class="card-header row">
                    ...
                    <div class="col-sm-3">
                        @canany(['create-realisationTache','import-realisationTache','export-realisationTache'])
                        <x-crud-actions
                ...
                <div id="realisationTache-data-container" class="data-container">
                    @include('PkgGestionTaches::realisationTache._table')
                </div>
            </div>
        </div>
    </section>
