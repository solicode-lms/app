...
class BaseRealisationTache extends BaseModel
{
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->ownerRelationPath = "RealisationProjet.AffectationProjet.evaluateurs.user, RealisationProjet.AffectationProjet.Projet.Formateur.user,RealisationProjet.Apprenant.user";
