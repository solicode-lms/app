...
class BasePrioriteTacheImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return PrioriteTache|null
     */
    private function findExistingRecord($reference): ?PrioriteTache
    {
        if($reference == null) return null;
        return PrioriteTache::where('reference', $reference)->first();
    }
