...
class BaseHistoriqueRealisationTacheImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return HistoriqueRealisationTache|null
     */
    private function findExistingRecord($reference): ?HistoriqueRealisationTache
    {
        if($reference == null) return null;
        return HistoriqueRealisationTache::where('reference', $reference)->first();
    }
