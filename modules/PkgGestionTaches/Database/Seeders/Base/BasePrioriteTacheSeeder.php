...
class BasePrioriteTacheSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgGestionTaches/Database/data/prioriteTaches.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    ...
                    $prioriteTacheService->create($prioriteTacheData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'PrioriteTacheController';
        $controllerBaseName = 'prioriteTache';
        $domainName = 'PrioriteTache';
