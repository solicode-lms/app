...
class BaseRealisationProjetController extends AdminController
{
    ...
    public function bulkUpdate(Request $request) {
        ...
        $request->validate([
            'realisationProjet_ids'   => ['required', 'array', 'min:1'],
            'fields_modifiables'               => ['required', 'array', 'min:1']
        ]);

        $ids          = $request->input('realisationProjet_ids', []);
        ...
        $form         = new \Modules\PkgRealisationProjets\App\Requests\RealisationProjetRequest();
        ...
        foreach ($ids as $id) {
            $model = $this->realisationProjetService->find($id);
    ...
    {
        // $this->authorizeAction('update');
        $itemRealisationProjet = RealisationProjet::findOrFail($id);
        ...
        $data = $this->service->buildFieldMeta($itemRealisationProjet, $field);
        return response()->json(
            $data
        );
    }
    ...
    public function patchInline(Request $request, int $id)
    {
        ...
        $etag = $this->service->etag($itemRealisationProjet);
        ...
        $updated = $this->service->applyInlinePatch($itemRealisationProjet, $changes);
