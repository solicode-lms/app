      ...
      <div class="form-group col-12 col-md-12">
          ...
          <label for="description">
            {{ ucfirst(__('PkgRealisationProjets::livrablesRealisation.description')) }}
                ...
                id="description">
                {!! \App\Helpers\TextHelper::sanitizeTextarea(old('description', $itemLivrablesRealisation->description ?? '')) !!}
                </textarea>
          @error('description')
            <div class="text-danger">{{ $message }}</div>
          @enderror
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemLivrablesRealisation" field="realisation_projet_id" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="realisation_projet_id" 
              id="bulk_field_realisation_projet_id" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
