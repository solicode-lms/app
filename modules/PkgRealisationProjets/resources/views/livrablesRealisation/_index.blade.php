...
<script>
    ...
    window.crudModalManagersConfig.push({
        ...
        canEdit: @json(Auth::user()->can('edit-livrablesRealisation')),
    ...
    <section id="livrablesRealisation-crud-table" class="content crud-table">
        <div class="container-fluid">
            <div class="card card-outline card-info " id="card_crud">
                        ...
                        <div class="col-sm-4">
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                <x-crud-actions
                                    ...
                                    :total="$livrablesRealisations_total"
                                />
                            </div>
                ...
                @if(!empty($livrablesRealisations_total) &&  $livrablesRealisations_total > 50)
                <div class="card-header">
                ...
                @section('livrablesRealisation-crud-bulk-actions')
