...
<div class="card-body table-responsive p-0 crud-card-body" id="affectationProjets-crud-card-body">
    <table class="table table-striped text-nowrap">
        <thead>
            <tr>
                <x-sortable-column field="projet_id" modelname="affectationProjet" label="{{ ucfirst(__('PkgRealisationProjets::affectationProjet.projet_id')) }}" />
                <x-sortable-column field="groupe_id" modelname="affectationProjet" label="{{ ucfirst(__('PkgRealisationProjets::affectationProjet.groupe_id')) }}" />
