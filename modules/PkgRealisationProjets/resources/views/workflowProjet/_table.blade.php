        ...
        <tbody>
            ...
            @foreach ($workflowProjets_data as $workflowProjet)
                <tr id="workflowProjet-row-{{$workflowProjet->id}}" data-id="{{$workflowProjet->id}}">
                    ...
                    <td style="max-width: 5%;" class="editable-cell text-truncate" data-id="{{$workflowProjet->id}}" data-field="ordre"  data-toggle="tooltip" title="{{ $workflowProjet->ordre }}" >
                    ...
                    <td style="max-width: 25.666666666666668%;" class="editable-cell text-truncate" data-id="{{$workflowProjet->id}}" data-field="code"  data-toggle="tooltip" title="{{ $workflowProjet->code }}" >
                    <x-field :entity="$workflowProjet" field="code">
                        {{ $workflowProjet->code }}
                    </x-field>
                    </td>
                    <td style="max-width: 25.666666666666668%;" class="editable-cell text-truncate" data-id="{{$workflowProjet->id}}" data-field="titre"  data-toggle="tooltip" title="{{ $workflowProjet->titre }}" >
                    <x-field :entity="$workflowProjet" field="titre">
                        {{ $workflowProjet->titre }}
                    </x-field>
                    </td>
                    <td style="max-width: 25.666666666666668%;" class="editable-cell text-truncate" data-id="{{$workflowProjet->id}}" data-field="sys_color_id"  data-toggle="tooltip" title="{{ $workflowProjet->sysColor }}" >
