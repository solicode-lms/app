...
<script>
    ...
    window.crudModalManagersConfig.push({
        ...
        fieldMetaUrl: '{{ route('etatsRealisationProjets.field.meta',  ['id' => ':id', 'field' => ':field']) }}',
        patchInlineUrl: '{{ route('etatsRealisationProjets.patchInline',  ['id' => ':id']) }}',
    ...
    <section id="etatsRealisationProjet-crud-table" class="content crud-table">
        <div class="container-fluid">
            <div class="card card-outline card-info " id="card_crud">
                ...
                @if(!empty($etatsRealisationProjets_total) &&  $etatsRealisationProjets_total > 10)
                <div class="card-header">
