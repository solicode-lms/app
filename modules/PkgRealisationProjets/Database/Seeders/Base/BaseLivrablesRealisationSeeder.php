...
class BaseLivrablesRealisationSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgRealisationProjets/Database/data/livrablesRealisations.csv");
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'LivrablesRealisationController';
        $controllerBaseName = 'livrablesRealisation';
        $domainName = 'LivrablesRealisation';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Afficher' => ['show'],
            'Lecture' => ['index', 'show'],
            'Édition sans Ajouter' => ['index', 'show','edit','update','getLivrablesRealisations','dataCalcul'],
