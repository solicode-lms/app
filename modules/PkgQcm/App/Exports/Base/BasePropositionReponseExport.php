    ...
    public function headings(): array
    {
        if ($this->format === 'csv') {
            return [
                ...
                'question_lib_reference' => 'question_reference',
            ...
            return [
                ...
                'question_lib_reference' => __('PkgQcm::question.singular'),
    ...
    public function collection()
    {
        return $this->data->map(function ($propositionReponse) {
            return [
                ...
                'question_reference' => $propositionReponse->questionLib?->reference,
