...
class BaseAffectationQcmProjetExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    protected $data;
    protected $format;
    ...
    {
        return $this->data->map(function ($affectationQcmProjet) {
            return [
                'reference' => $affectationQcmProjet->reference,
