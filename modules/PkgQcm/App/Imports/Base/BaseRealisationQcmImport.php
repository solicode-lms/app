...
class BaseRealisationQcmImport implements ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        ...
        return new RealisationQcm([
             ...
             'date_soumission' => $values[3] ?? null,
             'statut' => $values[4] ?? null,
             'date_validation' => $values[5] ?? null,
             'affectation_qcm_projet_id' => $values[6] ?? null,
             'etat_realisation_qcm_id' => $values[7] ?? null,
             'qcm_id' => $values[8] ?? null,
             'apprenant_id' => $values[9] ?? null,
        ]);
