...
class BaseQuestionLibImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return QuestionLib|null
     */
    private function findExistingRecord($reference): ?QuestionLib
    {
        if($reference == null) return null;
        return QuestionLib::where('reference', $reference)->first();
    }
