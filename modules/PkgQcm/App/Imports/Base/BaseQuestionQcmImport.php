...
class BaseQuestionQcmImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return QuestionQcm|null
     */
    private function findExistingRecord($reference): ?QuestionQcm
    {
        if($reference == null) return null;
        return QuestionQcm::where('reference', $reference)->first();
    }
