...
class BaseQcmImport implements ToModel, WithHeadingRow
{
    /**
     ...
     * @return Qcm|null
     */
    private function findExistingRecord($reference): ?Qcm
    {
        if($reference == null) return null;
        return Qcm::where('reference', $reference)->first();
    }
    ...
    public function model(array $row)
    {
        ...
        return new Qcm([
             ...
             'duree_minutes' => $values[3] ?? null,
             'is_duree_limitee' => $values[4] ?? null,
             'is_publie' => $values[5] ?? null,
