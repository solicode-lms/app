...
class BaseQuestionImport implements ToModel, WithHeadingRow
{
    /**
     ...
     */
    private function findExistingRecord($reference): ?Question
    {
        if($reference == null) return null;
        return Question::where('reference', $reference)->first();
    }
