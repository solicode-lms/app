...
namespace Modules\PkgQcm\App\Providers\Base;
...
class BasePkgQcmServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgQcm');
    ...
    protected function registerObservers()
    {
        ...
        $modelNamespace = 'Modules\\PkgQcm\\Models\\';
