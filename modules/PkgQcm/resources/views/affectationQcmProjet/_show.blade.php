...
<div id="affectationQcmProjet-crud-show">
        <div class="card-body">
            ...
            <div class="show_group col-12 col-md-6 col-lg-6 mb-3 px-2 ">
                <div class="border rounded p-2 h-100">
                  <small class="text-muted d-block">{{ ucfirst(__('PkgQcm::affectationQcmProjet.date_affectation')) }}</small>
                  <span>
                    @if ($itemAffectationQcmProjet->date_affectation)
                    {{ \Carbon\Carbon::parse($itemAffectationQcmProjet->date_affectation)->isoFormat('LLL') }}
                    @else
                    —
                    @endif
                  </span>                </div>
