...
class BaseEtatRealisationQcmSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgQcm/Database/data/etatRealisationQcms.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $etatRealisationQcm = null;
                if (!empty($row["reference"])) {
                    $etatRealisationQcm = $etatRealisationQcmService->updateOrCreate(["reference" => $row["reference"]], $etatRealisationQcmData);
                } else {
                    $etatRealisationQcm = $etatRealisationQcmService->create($etatRealisationQcmData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'EtatRealisationQcmController';
        $controllerBaseName = 'etatRealisationQcm';
        $domainName = 'EtatRealisationQcm';
