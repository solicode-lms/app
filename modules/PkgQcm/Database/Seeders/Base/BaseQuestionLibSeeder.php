...
class BaseQuestionLibSeeder extends Seeder
{
    public static int $order = 104;
    ...
    {
        $filePath = base_path("modules/PkgQcm/Database/data/questionLibs.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $questionLib = $questionLibService->updateOrCreate(["reference" => $row["reference"]], $questionLibData);
                } else {
                    $questionLib = $questionLibService->create($questionLibData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'QuestionLibController';
        $controllerBaseName = 'questionLib';
        $domainName = 'QuestionLib';
