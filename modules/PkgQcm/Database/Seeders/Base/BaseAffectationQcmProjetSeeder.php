...
class BaseAffectationQcmProjetSeeder extends Seeder
{
    public static int $order = 106;
    ...
    {
        $filePath = base_path("modules/PkgQcm/Database/data/affectationQcmProjets.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $affectationQcmProjet = null;
                if (!empty($row["reference"])) {
                    $affectationQcmProjet = $affectationQcmProjetService->updateOrCreate(["reference" => $row["reference"]], $affectationQcmProjetData);
                } else {
                    $affectationQcmProjet = $affectationQcmProjetService->create($affectationQcmProjetData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'AffectationQcmProjetController';
        $controllerBaseName = 'affectationQcmProjet';
        $domainName = 'AffectationQcmProjet';
