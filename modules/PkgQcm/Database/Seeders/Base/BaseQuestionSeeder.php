...
class BaseQuestionSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgQcm/Database/data/questions.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $question = $questionService->updateOrCreate(["reference" => $row["reference"]], $questionData);
                } else {
                    $question = $questionService->create($questionData);
                }
            }
        }
