...
class BaseRealisationQcmController extends AdminController
{
    ...
    public function bulkEditForm(Request $request) {
        ...
        if (request()->ajax()) {
            return view('PkgQcm::realisationQcm._fields', compact('bulkEdit', 'realisationQcm_ids', 'itemRealisationQcm', 'affectationQcmProjets', 'qcms', 'apprenants', 'etatRealisationQcms'));
        }
        return view('PkgQcm::realisationQcm.bulk-edit', compact('bulkEdit', 'realisationQcm_ids', 'itemRealisationQcm', 'affectationQcmProjets', 'qcms', 'apprenants', 'etatRealisationQcms'));
    }
    /**
     */
