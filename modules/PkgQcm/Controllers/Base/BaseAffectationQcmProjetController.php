...
class BaseAffectationQcmProjetController extends AdminController
{
    ...
    public function create() {
        ...
        $bulkEdit = false;
        if (request()->ajax()) {
            return view('PkgQcm::affectationQcmProjet._fields', compact('bulkEdit' ,'itemAffectationQcmProjet', 'affectationProjets', 'qcms'));
        }
        return view('PkgQcm::affectationQcmProjet.create', compact('bulkEdit' ,'itemAffectationQcmProjet', 'affectationProjets', 'qcms'));
    }
    /**
    ...
    public function bulkEditForm(Request $request) {
        ...
        if (request()->ajax()) {
            return view('PkgQcm::affectationQcmProjet._fields', compact('bulkEdit', 'affectationQcmProjet_ids', 'itemAffectationQcmProjet', 'affectationProjets', 'qcms'));
        }
        return view('PkgQcm::affectationQcmProjet.bulk-edit', compact('bulkEdit', 'affectationQcmProjet_ids', 'itemAffectationQcmProjet', 'affectationProjets', 'qcms'));
    }
    /**
     */
    ...
    public function edit(string $id) {
        ...
        if (request()->ajax()) {
            return view('PkgQcm::affectationQcmProjet._edit', array_merge(compact('bulkEdit' , 'itemAffectationQcmProjet','affectationProjets', 'qcms'),$realisationQcm_compact_value));
        }

        return view('PkgQcm::affectationQcmProjet.edit', array_merge(compact('bulkEdit' ,'itemAffectationQcmProjet','affectationProjets', 'qcms'),$realisationQcm_compact_value));
