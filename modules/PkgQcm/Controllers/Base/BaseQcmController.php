...
class BaseQcmController extends AdminController
{
    ...
    public function index(Request $request) {
        ...
        // ownedByUser
        if(Auth::user()->hasRole('formateur') && $this->viewState->get('filter.qcm.formateur_id') == null){
           $this->viewState->init('filter.qcm.formateur_id'  , $this->sessionState->get('formateur_id'));
        }
    ...
    public function show(string $id) {
        ...
        $this->viewState->set('scope.questionQcm.qcm_id', $id);
        ...
        if (request()->ajax()) {
            return view('PkgQcm::qcm._show', array_merge(compact('itemQcm'),$affectationQcmProjet_compact_value, $questionQcm_compact_value, $realisationQcm_compact_value));
        }

        return view('PkgQcm::qcm.show', array_merge(compact('itemQcm'),$affectationQcmProjet_compact_value, $questionQcm_compact_value, $realisationQcm_compact_value));
    ...
    public function edit(string $id) {
        ...
        if (request()->ajax()) {
            return view('PkgQcm::qcm._edit', array_merge(compact('bulkEdit' , 'itemQcm','formateurs'),$affectationQcmProjet_compact_value, $questionQcm_compact_value, $realisationQcm_compact_value));
        }

        return view('PkgQcm::qcm.edit', array_merge(compact('bulkEdit' ,'itemQcm','formateurs'),$affectationQcmProjet_compact_value, $questionQcm_compact_value, $realisationQcm_compact_value));
