...
class BaseQuestionController extends AdminController
{
    ...
    public function bulkEditForm(Request $request) {
        ...
        if (request()->ajax()) {
            return view('PkgQcm::question._fields', compact('bulkEdit', 'question_ids', 'itemQuestion', 'qcms', 'uniteApprentissages'));
        }
        return view('PkgQcm::question.bulk-edit', compact('bulkEdit', 'question_ids', 'itemQuestion', 'qcms', 'uniteApprentissages'));
    }
    /**
     */
