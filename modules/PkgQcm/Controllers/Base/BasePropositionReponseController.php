...
class BasePropositionReponseController extends AdminController
{
    ...
    public function __construct(PropositionReponseService $propositionReponseService, ReponseQcmService $reponseQcmService, QuestionService $questionService) {
        parent::__construct();
    ...
    public function bulkEditForm(Request $request) {
        ...
        $questions = $this->questionService->getAllForSelect($itemPropositionReponse->question);
        ...
        if (request()->ajax()) {
            return view('PkgQcm::propositionReponse._fields', compact('bulkEdit', 'propositionReponse_ids', 'itemPropositionReponse', 'questions', 'reponseQcms'));
        }
        return view('PkgQcm::propositionReponse.bulk-edit', compact('bulkEdit', 'propositionReponse_ids', 'itemPropositionReponse', 'questions', 'reponseQcms'));
    }
    /**
     */
