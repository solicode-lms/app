...
class BasePhaseProjetImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return PhaseProjet|null
     */
    private function findExistingRecord($reference): ?PhaseProjet
    {
        if($reference == null) return null;
        return PhaseProjet::where('reference', $reference)->first();
    }
