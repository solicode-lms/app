...
class BaseTacheRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'projet_origine_note_id' => 'nullable',
    ...
    public function messages(): array
    {
        return [
            ...
            'phase_projet_id.required' => __('validation.required', ['attribute' => __('PkgCreationTache::Tache.phase_projet_id')]),
            ...
            'projet_origine_note_id.required' => __('validation.required', ['attribute' => __('PkgCreationTache::Tache.projet_origine_note_id')]),
