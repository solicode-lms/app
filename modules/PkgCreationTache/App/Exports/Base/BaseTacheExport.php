    ...
    public function headings(): array
    {
        if ($this->format === 'csv') {
            return [
                ...
                'reference' => 'reference',
                'note' => 'note',
                'phase_projet_reference' => 'phase_projet_reference',
            ...
            return [
                ...
                'phase_projet_reference' => __('PkgCreationTache::phaseProjet.singular'),
    ...
    public function collection()
    {
        return $this->data->map(function ($tache) {
            return [
                ...
                'note' => $tache->note,
                'phase_projet_reference' => $tache->phaseProjet?->reference,
