...
namespace Modules\PkgCreationTache\App\Providers\Base;
...
class BasePkgCreationTacheServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgCreationTache');
    ...
    protected function registerObservers()
    {
        ...
        $namespace = 'Modules\\PkgCreationTache\\Observers\\';
        $modelNamespace = 'Modules\\PkgCreationTache\\Models\\';
