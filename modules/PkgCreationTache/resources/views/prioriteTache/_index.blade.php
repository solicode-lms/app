...
<script>
    ...
    window.crudModalManagersConfig.push({
        ...
        fieldMetaUrl: '{{ route('prioriteTaches.field.meta',  ['id' => ':id', 'field' => ':field']) }}',
        patchInlineUrl: '{{ route('prioriteTaches.patchInline',  ['id' => ':id']) }}',
        showUrl: '{{ route('prioriteTaches.show',  ['prioriteTache' => ':id']) }}',
        getEntityUrl: '{{ route("prioriteTaches.getById", ["id" => ":id"]) }}',
...
<div id="prioriteTache-crud" class="crud">
    ...
    @endphp
    <x-crud-header 
        id="prioriteTache-crud-header" icon="fas fa-table"  
        iconColor="text-info"
