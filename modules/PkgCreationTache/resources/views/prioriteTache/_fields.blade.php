...
<form 
    ...
    @if ($itemPrioriteTache->id)
        <input type="hidden" name="id" value="{{ $itemPrioriteTache->id }}">
        @method('PUT')
    @endif
    @if ($bulkEdit && !empty($prioriteTache_ids))
    ...
    <div class="row">
        <x-form-field :defined_vars="get_defined_vars()" :entity="$itemPrioriteTache" field="ordre" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          @endif
          <label for="ordre">
            {{ ucfirst(__('PkgCreationTache::prioriteTache.ordre')) }}
            <span class="text-danger">*</span>
                ...
                id="ordre"
                placeholder="{{ __('PkgCreationTache::prioriteTache.ordre') }}"
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemPrioriteTache" field="nom" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          @endif
          <label for="nom">
            {{ ucfirst(__('PkgCreationTache::prioriteTache.nom')) }}
            <span class="text-danger">*</span>
          </label>
           <input
                name="nom"
                ...
                id="nom"
                placeholder="{{ __('PkgCreationTache::prioriteTache.nom') }}"
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemPrioriteTache" field="description" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-12">
          ...
          <label for="description">
            {{ ucfirst(__('PkgCreationTache::prioriteTache.description')) }}
                ...
                id="description"
                placeholder="{{ __('PkgCreationTache::prioriteTache.description') }}">{{ $itemPrioriteTache ? $itemPrioriteTache->description : old('description') }}</textarea>
          @error('description')
            <div class="text-danger">{{ $message }}</div>
          @enderror
      </div>
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemPrioriteTache" field="formateur_id" :bulkEdit="$bulkEdit">
...
<script>
    ...
    @if ($bulkEdit)
        window.modalTitle = '{{__("PkgCreationTache::prioriteTache.singular") }} : {{__("Core::msg.edition_en_masse") }}'
    @else
