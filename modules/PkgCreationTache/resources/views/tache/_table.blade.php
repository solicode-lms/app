    ...
    <table class="table table-striped text-nowrap" style="table-layout: fixed; width: 100%;">
        <thead style="width: 100%">
            <tr>
                ...
                <x-sortable-column :sortable="true" width="9" field="mobilisation_ua_id" modelname="tache" label="{!!ucfirst(__('PkgCreationProjet::mobilisationUa.singular'))!!}" />
        ...
        <tbody>
            ...
            @foreach ($taches_data as $tache)
                ...
                <tr id="tache-row-{{$tache->id}}" data-id="{{$tache->id}}">
                    ...
                    <td style="max-width: 9%;white-space: normal;" class="{{ $isEditable ? 'editable-cell' : '' }} text-truncate" data-id="{{$tache->id}}" data-field="mobilisation_ua_id">
                        {{  $tache->mobilisationUa }}
