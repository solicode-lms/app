...
class BasePhaseProjetSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgCreationTache/Database/data/phaseProjets.csv");
        ...
        $phaseProjetService = new PhaseProjetService();
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $phaseProjet = $phaseProjetService->updateOrCreate(["reference" => $row["reference"]], $phaseProjetData);
                } else {
                    $phaseProjet = $phaseProjetService->create($phaseProjetData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'PhaseProjetController';
        $controllerBaseName = 'phaseProjet';
        $domainName = 'PhaseProjet';
