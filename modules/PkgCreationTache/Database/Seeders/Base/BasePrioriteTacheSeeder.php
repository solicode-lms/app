        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $prioriteTache = $prioriteTacheService->updateOrCreate(["reference" => $row["reference"]], $prioriteTacheData);
                } else {
                    $prioriteTache = $prioriteTacheService->create($prioriteTacheData);
                }
            }
        }
