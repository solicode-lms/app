...
class BaseProfileSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgAutorisation/Database/data/profiles.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $profile = $profileService->updateOrCreate(["reference" => $row["reference"]], $profileData);
                } else {
                    $profile = $profileService->create($profileData);
                }
            }
        }
