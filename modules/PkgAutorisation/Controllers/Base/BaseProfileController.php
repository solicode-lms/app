...
class BaseProfileController extends AdminController
{
    ...
    public function bulkUpdate(Request $request) {
        ...
        $form         = new \Modules\PkgAutorisation\App\Requests\ProfileRequest();
    ...
    {
        // $this->authorizeAction('update');
        $itemProfile = Profile::findOrFail($id);


        $data = $this->service->buildFieldMeta($itemProfile, $field);
        return response()->json(
            $data
        );
    }
    ...
    public function patchInline(Request $request, int $id)
    {
        ...
        $etag = $this->service->etag($itemProfile);
        ...
        $updated = $this->service->applyInlinePatch($itemProfile, $changes);
