...
class BaseProfileImport implements ToModel, WithHeadingRow
{
    /**
     ...
     * @return Profile|null
     */
    private function findExistingRecord($reference): ?Profile
    {
        if($reference == null) return null;
        return Profile::where('reference', $reference)->first();
    }
