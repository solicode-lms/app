...
class BaseEMetadatum extends BaseModel
{
     ...
     */
    protected $fillable = [
        'code', 'value_boolean', 'value_string', 'value_int', 'value_object', 'object_id', 'object_code', 'object_type', 'e_metadata_definition_code', 'e_metadata_definition_id', 'EModel', 'EDataField'
    ];
