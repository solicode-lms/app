...
<form 
    ...
    @if ($itemEPackage->id)
        <input type="hidden" name="id" value="{{ $itemEPackage->id }}">
        @method('PUT')
    @endif
    ...
    <div class="row">
        <x-form-field :defined_vars="get_defined_vars()" :entity="$itemEPackage" field="name" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemEPackage" field="description" :bulkEdit="$bulkEdit">
