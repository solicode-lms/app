    ...
    <table class="table table-striped text-nowrap">
        <thead>
            <tr>
                ...
                <x-sortable-column field="source_e_model_id" modelname="eRelationship" label="{{ ucfirst(__('PkgGapp::eRelationship.source_e_model_id')) }}" />
                <x-sortable-column field="target_e_model_id" modelname="eRelationship" label="{{ ucfirst(__('PkgGapp::eRelationship.target_e_model_id')) }}" />
