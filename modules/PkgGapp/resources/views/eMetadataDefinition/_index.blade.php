...
<script>
    ...
    window.crudModalManagersConfig.push({
        ...
        fieldMetaUrl: '{{ route('eMetadataDefinitions.field.meta',  ['id' => ':id', 'field' => ':field']) }}',
        patchInlineUrl: '{{ route('eMetadataDefinitions.patchInline',  ['id' => ':id']) }}',
        ...
        canEdit: @json(Auth::user()->can('edit-eMetadataDefinition')),
    ...
    <section id="eMetadataDefinition-crud-table" class="content crud-table">
        <div class="container-fluid">
            <div class="card card-outline card-info " id="card_crud">
                ...
                @if(!empty($eMetadataDefinitions_total) &&  $eMetadataDefinitions_total > 5)
                <div class="card-header">
