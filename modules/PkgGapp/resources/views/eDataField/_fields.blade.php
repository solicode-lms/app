...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemEDataField" field="e_relationship_id" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-3">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="e_relationship_id" 
              id="bulk_field_e_relationship_id" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemEDataField" field="calculable_sql" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-12">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="calculable_sql" 
              id="bulk_field_calculable_sql" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
          <label for="calculable_sql">
            {{ ucfirst(__('PkgGapp::eDataField.calculable_sql')) }}
                ...
                id="calculable_sql">
                {!! \App\Helpers\TextHelper::sanitizeTextarea(old('calculable_sql', $itemEDataField->calculable_sql ?? '')) !!}
                </textarea>
      ...
      <div class="form-group col-12 col-md-12">
          ...
          <label for="description">
            {{ ucfirst(__('PkgGapp::eDataField.description')) }}
                ...
                id="description">
                {!! \App\Helpers\TextHelper::sanitizeTextarea(old('description', $itemEDataField->description ?? '')) !!}
                </textarea>
          @error('description')
            <div class="text-danger">{{ $message }}</div>
          @enderror
