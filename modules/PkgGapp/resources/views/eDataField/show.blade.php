            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="col-sm-12">
                                <label for="code">{{ ucfirst(__('PkgGapp::eDataField.code')) }}:</label>
                                <p>{{ $itemEDataField->code }}</p>
                            </div>
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <label for="e_model_code">{{ ucfirst(__('PkgGapp::eDataField.e_model_code')) }}:</label>
                                <p>{{ $itemEDataField->e_model_code }}</p>
                            </div>
                            <div class="col-sm-12">
