...
class BaseDataFieldSeeder extends Seeder
{
    ...
    {
        $csvFile = fopen(base_path("modules/PkgGapp/Database/data/dataFields.csv"), "r");
        $firstline = true;
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'DataFieldController';
        $controllerBaseName = 'dataField';
        $domainName = 'DataField';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Édition ' => [ 'create','store','edit','update','destroy','getDataFields'],
            'Lecture' => ['index', 'show'],
