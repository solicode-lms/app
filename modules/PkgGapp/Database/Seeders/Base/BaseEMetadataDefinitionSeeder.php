...
class BaseEMetadataDefinitionSeeder extends Seeder
{
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $eMetadataDefinitionData =[
                        ...
                        "groupe" => !empty($row["groupe"]) ? $row["groupe"] : null,
                        "type" => !empty($row["type"]) ? $row["type"] : null,
                        "scope" => !empty($row["scope"]) ? $row["scope"] : null,
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'EMetadataDefinitionController';
        $controllerBaseName = 'eMetadataDefinition';
        $domainName = 'EMetadataDefinition';
