...
class BaseMetadataTypeSeeder extends Seeder
{
    ...
    {
        $csvFile = fopen(base_path("modules/PkgGapp/Database/data/metadataTypes.csv"), "r");
        $firstline = true;
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'MetadataTypeController';
        $controllerBaseName = 'metadataType';
        $domainName = 'MetadataType';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Édition ' => [ 'create','store','edit','update','destroy','getMetadataTypes'],
            'Lecture' => ['index', 'show'],
