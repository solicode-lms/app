...
class BaseIModelSeeder extends Seeder
{
    ...
    {
        $csvFile = fopen(base_path("modules/PkgGapp/Database/data/iModels.csv"), "r");
        $firstline = true;
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'IModelController';
        $controllerBaseName = 'iModel';
        $domainName = 'IModel';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Édition ' => [ 'create','store','edit','update','destroy','getIModels'],
            'Lecture' => ['index', 'show'],
