...
class BaseFieldTypeSeeder extends Seeder
{
    ...
    {
        $csvFile = fopen(base_path("modules/PkgGapp/Database/data/fieldTypes.csv"), "r");
        $firstline = true;
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'FieldTypeController';
        $controllerBaseName = 'fieldType';
        $domainName = 'FieldType';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Édition ' => [ 'create','store','edit','update','destroy','getFieldTypes'],
            'Lecture' => ['index', 'show'],
