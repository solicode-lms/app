...
class BaseIPackageSeeder extends Seeder
{
    ...
    {
        $csvFile = fopen(base_path("modules/PkgGapp/Database/data/iPackages.csv"), "r");
        $firstline = true;
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'IPackageController';
        $controllerBaseName = 'iPackage';
        $domainName = 'IPackage';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Édition ' => [ 'create','store','edit','update','destroy','getIPackages'],
            'Lecture' => ['index', 'show'],
