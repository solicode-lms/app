...
class BaseEPackageSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgGapp/Database/data/ePackages.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($data["reference"])) {
                    $ePackageService->updateOrCreate(["reference" => $data["reference"]], $ePackageData);
                } else {
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'EPackageController';
        $controllerBaseName = 'ePackage';
        $domainName = 'EPackage';
