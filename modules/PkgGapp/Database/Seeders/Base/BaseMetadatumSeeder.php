...
class BaseMetadatumSeeder extends Seeder
{
    ...
    {
        $csvFile = fopen(base_path("modules/PkgGapp/Database/data/metadata.csv"), "r");
        $firstline = true;
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'MetadatumController';
        $controllerBaseName = 'metadatum';
        $domainName = 'Metadatum';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Édition ' => [ 'create','store','edit','update','destroy','getMetadata'],
            'Lecture' => ['index', 'show'],
