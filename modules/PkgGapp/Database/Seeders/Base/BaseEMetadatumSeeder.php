    ...
    public function seedFromCsv(): void
    {
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $eMetadatumData =[
                        "value_boolean" => $row["value_boolean"] === "" ? null : $row["value_boolean"],
                        "value_string" => $row["value_string"] === "" ? null : $row["value_string"],
                        "value_integer" => $row["value_integer"] === "" ? null : $row["value_integer"],
                        "value_float" => $row["value_float"] === "" ? null : $row["value_float"],
                        "value_date" => $row["value_date"] === "" ? null : $row["value_date"],
                        "value_datetime" => $row["value_datetime"] === "" ? null : $row["value_datetime"],
                        "value_enum" => $row["value_enum"] === "" ? null : $row["value_enum"],
                        "value_json" => $row["value_json"] === "" ? null : $row["value_json"],
                        "value_text" => $row["value_text"] === "" ? null : $row["value_text"],
