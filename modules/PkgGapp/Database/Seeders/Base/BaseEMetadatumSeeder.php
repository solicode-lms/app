    ...
    public function seedFromCsv(): void
    {
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $eMetadatumData =[
                        "value_boolean" => isset($row["value_boolean"]) && $row["value_boolean"] !== "" ? $row["value_boolean"] : null,
                        "value_string" => isset($row["value_string"]) && $row["value_string"] !== "" ? $row["value_string"] : null,
                        "value_integer" => isset($row["value_integer"]) && $row["value_integer"] !== "" ? $row["value_integer"] : null,
                        "value_float" => isset($row["value_float"]) && $row["value_float"] !== "" ? $row["value_float"] : null,
                        "value_date" => isset($row["value_date"]) && $row["value_date"] !== "" ? $row["value_date"] : null,
                        "value_datetime" => isset($row["value_datetime"]) && $row["value_datetime"] !== "" ? $row["value_datetime"] : null,
                        "value_enum" => isset($row["value_enum"]) && $row["value_enum"] !== "" ? $row["value_enum"] : null,
                        "value_json" => isset($row["value_json"]) && $row["value_json"] !== "" ? $row["value_json"] : null,
                        "value_text" => isset($row["value_text"]) && $row["value_text"] !== "" ? $row["value_text"] : null,
