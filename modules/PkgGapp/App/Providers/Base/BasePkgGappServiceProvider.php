...
namespace Modules\PkgGapp\App\Providers\Base;
...
class BasePkgGappServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgGapp');
    ...
    protected function registerObservers()
    {
        ...
        $namespace = 'Modules\\PkgGapp\\Observers\\';
        $modelNamespace = 'Modules\\PkgGapp\\Models\\';
