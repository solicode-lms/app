    ...
    public function collection()
    {
        return $this->data->map(function ($eDataField) {
            return [
                ...
                'db_primaryKey' => $eDataField->db_primaryKey ? '1' : '0',
                'db_nullable' => $eDataField->db_nullable ? '1' : '0',
                'db_unique' => $eDataField->db_unique ? '1' : '0',
                'calculable' => $eDataField->calculable ? '1' : '0',
