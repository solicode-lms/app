    ...
    public function headings(): array
    {
        if ($this->format === 'csv') {
            return [
                ...
                'name' => 'name',
                'type' => 'type',
                'source_e_model_reference' => 'e_model_reference',
                'target_e_model_reference' => 'e_model_reference',
            ...
            return [
                ...
                'source_e_model_reference' => __('PkgGapp::eModel.singular'),
                'target_e_model_reference' => __('PkgGapp::eModel.singular'),
    ...
    public function collection()
    {
        return $this->data->map(function ($eRelationship) {
            return [
                ...
                'cascade_on_delete' => $eRelationship->cascade_on_delete ? '1' : '0',
                'is_cascade' => $eRelationship->is_cascade ? '1' : '0',
