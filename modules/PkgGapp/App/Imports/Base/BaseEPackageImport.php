...
class BaseEPackageImport implements ToModel, WithHeadingRow
{
    /**
     ...
     */
    private function findExistingRecord($reference): ?EPackage
    {
        if($reference == null) return null;
        return EPackage::where('reference', $reference)->first();
    }
