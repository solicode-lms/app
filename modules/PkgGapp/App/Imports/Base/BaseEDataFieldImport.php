...
class BaseEDataFieldImport implements ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        ...
        return new EDataField([
             ...
             'reference' => $reference,
             'name' => $values[2] ?? null,
             'data_type' => $values[3] ?? null,
             'column_name' => $values[4] ?? null,
             'e_model_id' => $values[5] ?? null,
             'e_relationship_id' => $values[6] ?? null,
             'field_order' => $values[7] ?? null,
             'default_value' => $values[8] ?? null,
             'db_primaryKey' => $values[9] ?? null,
             'db_nullable' => $values[10] ?? null,
