...
class BaseLabelRealisationTacheExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    protected $data;
    ...
    {
        return $this->data->map(function ($labelRealisationTache) {
            return [
                'nom' => $labelRealisationTache->nom,
                'description' => $labelRealisationTache->description,
                'reference' => $labelRealisationTache->reference,
                'formateur_id' => $labelRealisationTache->formateur_id,
                'sys_color_id' => $labelRealisationTache->sys_color_id,
            ];
        });
    }
