...
<div class="col-12 col-md-12">
  ...
  @include('PkgApprentissage::realisationChapitre._index',['isMany' => true, "edit_has_many" => false, "data_calcul" => false ,"parent_manager_id" => "realisationChapitre-crud","contextKey" => 'realisationTache.edit_' . $itemRealisationTache->id])
</div>
@endif
@endif
@endif
...
<div class="col-12 col-md-12">
  ...
  @include('PkgApprentissage::realisationUaProjet._index',['isMany' => true, "edit_has_many" => false, "data_calcul" => false ,"parent_manager_id" => "realisationUaProjet-crud","contextKey" => 'realisationTache.edit_' . $itemRealisationTache->id])
</div>
@endif
@endif
@endif
...
<div class="col-12 col-md-12">
  ...
  @include('PkgApprentissage::realisationUaPrototype._index',['isMany' => true, "edit_has_many" => false, "data_calcul" => true ,"parent_manager_id" => "realisationUaPrototype-crud","contextKey" => 'realisationTache.edit_' . $itemRealisationTache->id])
</div>
@endif
@endif
@endif
...
<div class="col-12 col-md-12">
  ...
  @include('PkgEvaluateurs::evaluationRealisationTache._index',['isMany' => true, "edit_has_many" => false, "data_calcul" => false ,"parent_manager_id" => "evaluationRealisationTache-crud","contextKey" => 'realisationTache.edit_' . $itemRealisationTache->id])
</div>
@endif
@endif
@endif
...
<div class="col-12 col-md-12">
  ...
  @include('PkgRealisationTache::historiqueRealisationTache._index',['isMany' => true, "edit_has_many" => false, "data_calcul" => false ,"parent_manager_id" => "historiqueRealisationTache-crud","contextKey" => 'realisationTache.edit_' . $itemRealisationTache->id])
</div>
@endif
@endif
@endif
