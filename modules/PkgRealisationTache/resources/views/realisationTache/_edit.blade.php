            ...
            <div class="row">
                ...
                <div id="card-tab-realisationTache" class="card card-info card-tabs card-workflow">
                    <div class="card-header d-flex justify-content-between p-0 pt-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="realisationTache-hasmany-tabs-realisationChapitre-tab" data-toggle="pill" href="#realisationTache-hasmany-tabs-realisationChapitre" role="tab" aria-controls="realisationTache-hasmany-tabs-realisationChapitre" aria-selected="false">{{ucfirst(__('PkgApprentissage::realisationChapitre.plural'))}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="realisationTache-hasmany-tabs-realisationUaProjet-tab" data-toggle="pill" href="#realisationTache-hasmany-tabs-realisationUaProjet" role="tab" aria-controls="realisationTache-hasmany-tabs-realisationUaProjet" aria-selected="false">{{ucfirst(__('PkgApprentissage::realisationUaProjet.plural'))}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="realisationTache-hasmany-tabs-realisationUaPrototype-tab" data-toggle="pill" href="#realisationTache-hasmany-tabs-realisationUaPrototype" role="tab" aria-controls="realisationTache-hasmany-tabs-realisationUaPrototype" aria-selected="false">{{ucfirst(__('PkgApprentissage::realisationUaPrototype.plural'))}}</a>
                        </li>
