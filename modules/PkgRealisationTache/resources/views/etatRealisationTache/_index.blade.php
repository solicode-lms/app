...
<script>
    ...
    window.crudModalManagersConfig.push({
        ...
        fieldMetaUrl: '{{ route('etatRealisationTaches.field.meta',  ['id' => ':id', 'field' => ':field']) }}',
        patchInlineUrl: '{{ route('etatRealisationTaches.patchInline',  ['id' => ':id']) }}',
    ...
    <section id="etatRealisationTache-crud-table" class="content crud-table">
        <div class="container-fluid">
            <div class="card card-outline card-info " id="card_crud">
                        ...
                        <div class="col-sm-4">
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                <x-crud-actions
                                    ...
                                    :total="$etatRealisationTaches_total"
                                />
                            </div>
                ...
                @if(!empty($etatRealisationTaches_total) &&  $etatRealisationTaches_total > 50)
                <div class="card-header">
