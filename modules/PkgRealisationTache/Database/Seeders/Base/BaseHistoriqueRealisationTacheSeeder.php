...
class BaseHistoriqueRealisationTacheSeeder extends Seeder
{
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $historiqueRealisationTacheData =[
                        "changement" => isset($row["changement"]) && $row["changement"] !== "" ? $row["changement"] : null,
                        "dateModification" => isset($row["dateModification"]) && $row["dateModification"] !== "" ? $row["dateModification"] : null,
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'HistoriqueRealisationTacheController';
        $controllerBaseName = 'historiqueRealisationTache';
        $domainName = 'HistoriqueRealisationTache';
