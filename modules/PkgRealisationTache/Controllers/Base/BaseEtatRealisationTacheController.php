...
class BaseEtatRealisationTacheController extends AdminController
{
    ...
    public function bulkUpdate(Request $request) {
        ...
        $request->validate([
            'etatRealisationTache_ids'   => ['required', 'array', 'min:1'],
            'fields_modifiables'               => ['required', 'array', 'min:1']
        ]);

        $ids          = $request->input('etatRealisationTache_ids', []);
        ...
        $form         = new \Modules\PkgRealisationTache\App\Requests\EtatRealisationTacheRequest();
        ...
        foreach ($ids as $id) {
            $model = $this->etatRealisationTacheService->find($id);
    ...
    public function dataCalcul(Request $request)
    {
        ...
        return response()->json(  array_merge(
                   ['success' => true,'entity' => $updatedEtatRealisationTache],
                    $this->service->getCrudJobToken() ? ['traitement_token' => $this->service->getCrudJobToken()] : []
        ));
    }
    ...
    {
        // $this->authorizeAction('update');
        $itemEtatRealisationTache = EtatRealisationTache::findOrFail($id);


        $data = $this->service->buildFieldMeta($itemEtatRealisationTache, $field);
        return response()->json(
            $data
        );
    }
    ...
    public function patchInline(Request $request, int $id)
    {
        ...
        $etag = $this->service->etag($itemEtatRealisationTache);
        ...
        $updated = $this->service->applyInlinePatch($itemEtatRealisationTache, $changes);
