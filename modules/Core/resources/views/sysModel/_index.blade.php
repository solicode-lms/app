    ...
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        {{ curd_index_title('Core::sysModel') }}
                    </h1>
                </div>
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        @can('create-sysModel')
                        <button type="button" class="btn btn-info btn-sm addEntityButton" data-toggle="modal" data-target="#sysModelModal">
                            <i class="fas fa-plus"></i> {{ curd_index_add_label('Core::sysModel') }}
                        </button>
...
<div class="modal fade" id="sysModelModal" tabindex="-1" role="dialog" aria-labelledby="sysModelModalLabel" aria-hidden="true">
