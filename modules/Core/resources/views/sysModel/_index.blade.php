            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        @can('create-sysModel')
                        <button type="button" class="btn btn-info btn-sm addEntityButton" data-target="#sysModelModal">
...
<div class="modal fade crud-modal" id="sysModelModal" tabindex="-1" role="dialog" aria-labelledby="sysModelModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div id="modal-content-container" style="display: none;">
                <div class="modal-header">
                    <h5 class="modal-title" id="sysModelModalLabel"></h5>
