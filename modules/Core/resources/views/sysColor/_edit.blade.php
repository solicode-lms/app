            ...
            <div class="row">
                ...
                <div id="card-tab-sysColor" class="card card-info card-tabs card-workflow">
                    <div class="card-header d-flex justify-content-between p-0 pt-1">
                        ...
                        @endif
                         @if($itemRealisationTache->etatEvaluationProjets->count() > 0 || auth()->user()?->can('create-etatEvaluationProjet'))
                        <li class="nav-item">
                        ...
                        @endif
                         @if($itemRealisationTache->etatRealisationChapitres->count() > 0 || auth()->user()?->can('create-etatRealisationChapitre'))
                        <li class="nav-item">
                        ...
                        @endif
                         @if($itemRealisationTache->sysModules->count() > 0 || auth()->user()?->can('create-sysModule'))
                        <li class="nav-item">
                        ...
                        @endif
                         @if($itemRealisationTache->etatRealisationMicroCompetences->count() > 0 || auth()->user()?->can('create-etatRealisationMicroCompetence'))
                        <li class="nav-item">
                        ...
                        @endif
                         @if($itemRealisationTache->etatsRealisationProjets->count() > 0 || auth()->user()?->can('create-etatsRealisationProjet'))
                        <li class="nav-item">
                        ...
                        @endif
                         @if($itemRealisationTache->etatRealisationUas->count() > 0 || auth()->user()?->can('create-etatRealisationUa'))
                        <li class="nav-item">
                        ...
                        @endif
                         @if($itemRealisationTache->sectionWidgets->count() > 0 || auth()->user()?->can('create-sectionWidget'))
                        <li class="nav-item">
                        ...
                        @endif
                         @if($itemRealisationTache->workflowTaches->count() > 0 || auth()->user()?->can('create-workflowTache'))
                        <li class="nav-item">
