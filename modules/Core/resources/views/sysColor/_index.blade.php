            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        @can('create-sysColor')
                        <button type="button" class="btn btn-info btn-sm addEntityButton" data-toggle="modal" data-target="#sysColorModal">
                            <i class="fas fa-plus"></i> {{ curd_index_add_label('Core::sysColor') }}
                        </button>
...
<div class="modal fade" id="sysColorModal" tabindex="-1" role="dialog" aria-labelledby="sysColorModalLabel" aria-hidden="true">
