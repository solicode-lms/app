                        ...
                        <div class="card-header col-md-12">
                            <div class="p-0">
                                <div class="input-group input-group-sm float-sm-right col-md-3 p-0">
                                    <input type="text" value="{{ $featureDomain_searchQuery ?? '' }}" name="crud_search_input" id="crud_search_input"
...
<div class="modal fade crud-modal" id="featureDomainModal" tabindex="-1" role="dialog" aria-labelledby="featureDomainModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div id="modal-content-container" style="display: none;">
                <div class="modal-header">
                    <h5 class="modal-title" id="featureDomainModalLabel"></h5>
