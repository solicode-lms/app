...
<form 
    ...
    <div class="row">
        <x-form-field :entity="$itemFeature" field="name">
...
<x-form-field :entity="$itemFeature" field="description">
...
<x-form-field :entity="$itemFeature" field="feature_domain_id">
...
<x-form-field :entity="$itemFeature" field="permissions">
