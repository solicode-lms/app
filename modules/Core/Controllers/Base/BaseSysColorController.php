...
class BaseSysColorController extends AdminController
{
    ...
    public function export($format)
    {
        ...
        if ($format === 'csv') {
            return Excel::download(new SysColorExport($sysColors_data), 'sysColor_export.csv', \Maatwebsite\Excel\Excel::CSV, ['Content-Type' => 'text/csv']);
        } elseif ($format === 'xlsx') {
            return Excel::download(new SysColorExport($sysColors_data), 'sysColor_export.xlsx', \Maatwebsite\Excel\Excel::XLSX);
        } else {
