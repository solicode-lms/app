...
class BaseSysModuleSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/Core/Database/data/sysModules.csv");
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'SysModuleController';
        $controllerBaseName = 'sysModule';
        $domainName = 'SysModule';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Afficher' => ['show'],
            'Lecture' => ['index', 'show'],
            'Édition sans Ajouter' => ['index', 'show','edit','update','destroy','getSysModules','dataCalcul'],
            'Édition ' => [ 'index', 'show','create','store','edit','update','destroy','getSysModules','dataCalcul'],
