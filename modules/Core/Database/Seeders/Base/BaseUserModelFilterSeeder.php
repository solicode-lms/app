...
class BaseUserModelFilterSeeder extends Seeder
{
    public static int $order = 61;
    ...
    {
        $filePath = base_path("modules/Core/Database/data/userModelFilters.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $userModelFilterData =[
                        "user_id" => $user_id,
                        "model_name" => !empty($row["model_name"]) ? $row["model_name"] : null,
                        "filters" => !empty($row["filters"]) ? $row["filters"] : null,
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'UserModelFilterController';
        $controllerBaseName = 'userModelFilter';
        $domainName = 'UserModelFilter';
