...
class BaseFeatureDomainSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/Core/Database/data/featureDomains.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $featureDomain = $featureDomainService->updateOrCreate(["reference" => $row["reference"]], $featureDomainData);
                } else {
                    $featureDomain = $featureDomainService->create($featureDomainData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'FeatureDomainController';
        $controllerBaseName = 'featureDomain';
