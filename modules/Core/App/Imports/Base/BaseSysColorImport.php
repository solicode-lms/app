...
class BaseSysColorImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return SysColor|null
     */
    private function findExistingRecord($reference): ?SysColor
    {
        if($reference == null) return null;
        return SysColor::where('reference', $reference)->first();
    }
