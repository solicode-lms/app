...
class BaseUserModelFilterImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return UserModelFilter|null
     */
    private function findExistingRecord($reference): ?UserModelFilter
    {
        if($reference == null) return null;
        return UserModelFilter::where('reference', $reference)->first();
    }
