...
class BaseSysModelImport implements ToModel, WithHeadingRow
{
    /**
     ...
     */
    private function findExistingRecord($reference): ?SysModel
    {
        if($reference == null) return null;
        return SysModel::where('reference', $reference)->first();
    }
