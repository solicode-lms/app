...
class BaseFeatureImport implements ToModel, WithHeadingRow
{
    /**
     ...
     * @return Feature|null
     */
    private function findExistingRecord($reference): ?Feature
    {
        if($reference == null) return null;
        return Feature::where('reference', $reference)->first();
    }
