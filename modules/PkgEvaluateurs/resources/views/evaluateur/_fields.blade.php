...
<form 
    ...
    @if ($itemEvaluateur->id)
        <input type="hidden" name="id" value="{{ $itemEvaluateur->id }}">
        @method('PUT')
    @endif
    ...
    <div class="row">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          @endif
          <label for="nom">
            {{ ucfirst(__('PkgEvaluateurs::evaluateur.nom')) }}
           ...
           <input
                ...
                id="nom"
                placeholder="{{ __('PkgEvaluateurs::evaluateur.nom') }}"
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemEvaluateur" field="prenom" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          @endif
          <label for="prenom">
            {{ ucfirst(__('PkgEvaluateurs::evaluateur.prenom')) }}
            <span class="text-danger">*</span>
          </label>
           <input
                name="prenom"
                ...
                id="prenom"
                placeholder="{{ __('PkgEvaluateurs::evaluateur.prenom') }}"
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemEvaluateur" field="email" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          @endif
          <label for="email">
            {{ ucfirst(__('PkgEvaluateurs::evaluateur.email')) }}
            <span class="text-danger">*</span>
          </label>
           <input
                name="email"
                ...
                id="email"
                placeholder="{{ __('PkgEvaluateurs::evaluateur.email') }}"
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemEvaluateur" field="organism" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          @if ($bulkEdit)
          <div class="bulk-check">
              <input {{ $canEdittache_id ? '' : 'disabled' }} type="checkbox" class="check-input" name="fields_modifiables[]" value="organism" id="bulk_field_organism" title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
          <label for="organism">
            {{ ucfirst(__('PkgEvaluateurs::evaluateur.organism')) }}
           ...
           <input
                ...
                id="organism"
                placeholder="{{ __('PkgEvaluateurs::evaluateur.organism') }}"
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemEvaluateur" field="telephone" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          @if ($bulkEdit)
          <div class="bulk-check">
              <input {{ $canEdittache_id ? '' : 'disabled' }} type="checkbox" class="check-input" name="fields_modifiables[]" value="telephone" id="bulk_field_telephone" title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
          <label for="telephone">
            {{ ucfirst(__('PkgEvaluateurs::evaluateur.telephone')) }}
           ...
           <input
                ...
                id="telephone"
                placeholder="{{ __('PkgEvaluateurs::evaluateur.telephone') }}"
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemEvaluateur" field="affectationProjets" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          @if ($bulkEdit)
          <div class="bulk-check">
              <input {{ $canEdittache_id ? '' : 'disabled' }} type="checkbox" class="check-input" name="fields_modifiables[]" value="affectationProjets" id="bulk_field_affectationProjets" title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
...
<script>
    ...
    @if ($bulkEdit)
        window.modalTitle = '{{__("PkgEvaluateurs::evaluateur.singular") }} : {{__("Core::msg.edition_en_masse") }}'
    @else
