...
<script>
    ...
    window.editWithTabPanelManagersConfig.push({
        ...
        edit_title: '{{__("Core::msg.edit") . " : " . __("PkgEvaluateurs::evaluationRealisationProjet.singular") }} - {{ $itemEvaluationRealisationProjet }}',
    });
</script>
<script>
            ...
            <div class="row">
                ...
                <div id="card-tab-evaluationRealisationProjet" class="card card-info card-tabs card-workflow">
                    <div class="card-header d-flex justify-content-between p-0 pt-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="evaluationRealisationProjet-hasmany-tabs-home-tab" data-toggle="pill" href="#evaluationRealisationProjet-hasmany-tabs-home" role="tab" aria-controls="evaluationRealisationProjet-hasmany-tabs-home" aria-selected="true">{{__('PkgEvaluateurs::evaluationRealisationProjet.singular')}}</a>
                        </li>

                         @if($itemEvaluationRealisationProjet->evaluationRealisationTaches?->count() > 0 || auth()->user()?->can('create-evaluationRealisationTache'))
                        <li class="nav-item">
                            <a class="nav-link" id="evaluationRealisationProjet-hasmany-tabs-evaluationRealisationTache-tab" data-toggle="pill" href="#evaluationRealisationProjet-hasmany-tabs-evaluationRealisationTache" role="tab" aria-controls="evaluationRealisationProjet-hasmany-tabs-evaluationRealisationTache" aria-selected="false">
