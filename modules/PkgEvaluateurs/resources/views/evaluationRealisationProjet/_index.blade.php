...
<script>
    ...
    window.crudModalManagersConfig.push({
        ...
        fieldMetaUrl: '{{ route('evaluationRealisationProjets.field.meta',  ['id' => ':id', 'field' => ':field']) }}',
        patchInlineUrl: '{{ route('evaluationRealisationProjets.patchInline',  ['id' => ':id']) }}',
        ...
        create_title: '{{__("Core::msg.add") . " : " . __("PkgEvaluateurs::evaluationRealisationProjet.singular") }}',
        edit_title: '{{__("Core::msg.edit") . " : " . __("PkgEvaluateurs::evaluationRealisationProjet.singular") }}',
    });
</script>
<script>
...
<div id="evaluationRealisationProjet-crud" class="crud">
    ...
    @php
       ...
       $titre = __("PkgEvaluateurs::evaluationRealisationProjet.singular");
    @endphp
    <x-crud-header 
        id="evaluationRealisationProjet-crud-header" icon="fas fa-check-square"  
        iconColor="text-info"
    ...
    <section id="evaluationRealisationProjet-crud-table" class="content crud-table">
        <div class="container-fluid">
            <div class="card card-outline card-info " id="card_crud">
                        ...
                        <div class="col-sm-4">
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                <x-crud-actions
                                    ...
                                    :total="$evaluationRealisationProjets_total"
                                />
                            </div>
                ...
                @if(!empty($evaluationRealisationProjets_total) &&  $evaluationRealisationProjets_total > 10)
                <div class="card-header">
                ...
                <div id="evaluationRealisationProjet-data-container" class="data-container">
                    ...
                    @include("PkgEvaluateurs::evaluationRealisationProjet._$evaluationRealisationProjet_viewType")
                    @endif
                </div>
