...
class BaseEvaluateurSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgEvaluateurs/Database/data/evaluateurs.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $evaluateurData =[
                        ...
                        "organism" => isset($row["organism"]) && $row["organism"] !== "" ? $row["organism"] : null,
                        "telephone" => isset($row["telephone"]) && $row["telephone"] !== "" ? $row["telephone"] : null,
                        "user_id" => $user_id,
