...
class BaseEvaluationRealisationTacheController extends AdminController
{
    ...
    public function bulkEditForm(Request $request) {
        ...
        $realisationTaches = $this->realisationTacheService->getAllForSelect($itemEvaluationRealisationTache->realisationTache);
        $evaluateurs = $this->evaluateurService->getAllForSelect($itemEvaluationRealisationTache->evaluateur);
        $evaluationRealisationProjets = $this->evaluationRealisationProjetService->getAllForSelect($itemEvaluationRealisationTache->evaluationRealisationProjet);
        ...
        if (request()->ajax()) {
            return view('PkgEvaluateurs::evaluationRealisationTache._fields', compact('bulkEdit', 'evaluationRealisationTache_ids', 'itemEvaluationRealisationTache', 'realisationTaches', 'evaluateurs', 'evaluationRealisationProjets'));
        }
        return view('PkgEvaluateurs::evaluationRealisationTache.bulk-edit', compact('bulkEdit', 'evaluationRealisationTache_ids', 'itemEvaluationRealisationTache', 'realisationTaches', 'evaluateurs', 'evaluationRealisationProjets'));
    }
    /**
     */
    ...
    public function bulkUpdate(Request $request) {
        ...
        $request->validate([
            'evaluationRealisationTache_ids'   => ['required', 'array', 'min:1'],
            'fields_modifiables'               => ['required', 'array', 'min:1']
        ]);

        $ids          = $request->input('evaluationRealisationTache_ids', []);
        ...
        $form         = new \Modules\PkgEvaluateurs\App\Requests\EvaluationRealisationTacheRequest();
        ...
        foreach ($ids as $id) {
            $model = $this->evaluationRealisationTacheService->find($id);
    ...
    {
        // $this->authorizeAction('update');
        $itemEvaluationRealisationTache = EvaluationRealisationTache::findOrFail($id);


        $data = $this->service->buildFieldMeta($itemEvaluationRealisationTache, $field);
        return response()->json(
            $data
        );
    }
    ...
    public function patchInline(Request $request, int $id)
    {
        ...
        $etag = $this->service->etag($itemEvaluationRealisationTache);
        ...
        $updated = $this->service->applyInlinePatch($itemEvaluationRealisationTache, $changes);
