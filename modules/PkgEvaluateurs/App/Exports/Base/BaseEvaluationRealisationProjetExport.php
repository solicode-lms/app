...
class BaseEvaluationRealisationProjetExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    ...
    public function headings(): array
    {
     if($this->format == 'csv'){
        ...
        return [
            'realisation_projet_id' => __('PkgEvaluateurs::evaluationRealisationProjet.realisation_projet_id'),
            'evaluateur_id' => __('PkgEvaluateurs::evaluationRealisationProjet.evaluateur_id'),
            'date_evaluation' => __('PkgEvaluateurs::evaluationRealisationProjet.date_evaluation'),
            'etat_evaluation_projet_id' => __('PkgEvaluateurs::evaluationRealisationProjet.etat_evaluation_projet_id'),
