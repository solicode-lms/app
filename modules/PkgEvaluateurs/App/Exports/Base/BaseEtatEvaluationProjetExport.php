...
class BaseEtatEvaluationProjetExport implements FromCollection, WithHeadings, ShouldAutoSize, WithStyles
{
    ...
    public function headings(): array
    {
     if($this->format == 'csv'){
        ...
        return [
            'ordre' => __('PkgEvaluateurs::etatEvaluationProjet.ordre'),
            'code' => __('PkgEvaluateurs::etatEvaluationProjet.code'),
            'titre' => __('PkgEvaluateurs::etatEvaluationProjet.titre'),
            'description' => __('PkgEvaluateurs::etatEvaluationProjet.description'),
            'reference' => __('Core::msg.reference'),
            'sys_color_id' => __('PkgEvaluateurs::etatEvaluationProjet.sys_color_id'),
        ];
