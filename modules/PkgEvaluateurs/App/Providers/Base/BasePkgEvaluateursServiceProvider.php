...
namespace Modules\PkgEvaluateurs\App\Providers\Base;
...
class BasePkgEvaluateursServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgEvaluateurs');
    ...
    protected function registerObservers()
    {
        ...
        $namespace = 'Modules\\PkgEvaluateurs\\Observers\\';
        $modelNamespace = 'Modules\\PkgEvaluateurs\\Models\\';
