...
class BaseLivrableSeeder extends Seeder
{
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $livrableData =[
                        ...
                        "is_affichable_seulement_par_formateur" => $row["is_affichable_seulement_par_formateur"] === "" ? null : $row["is_affichable_seulement_par_formateur"],
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'LivrableController';
        $controllerBaseName = 'livrable';
        $domainName = 'Livrable';
