...
class BaseNatureLivrableSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgCreationProjet/Database/data/natureLivrables.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $natureLivrable = $natureLivrableService->updateOrCreate(["reference" => $row["reference"]], $natureLivrableData);
                } else {
                    $natureLivrable = $natureLivrableService->create($natureLivrableData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'NatureLivrableController';
        $controllerBaseName = 'natureLivrable';
        $domainName = 'NatureLivrable';
