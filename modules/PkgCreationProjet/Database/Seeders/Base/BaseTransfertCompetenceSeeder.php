...
class BaseTransfertCompetenceSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgCreationProjet/Database/data/transfertCompetences.csv");
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'TransfertCompetenceController';
        $controllerBaseName = 'transfertCompetence';
        $domainName = 'TransfertCompetence';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Afficher' => ['show'],
            'Lecture' => ['index', 'show'],
            'Édition sans Ajouter' => ['index', 'show','edit','update','destroy','getTransfertCompetences','dataCalcul'],
    ...
    private function assignPermissionsToRoles(string $AdminRole, string $MembreRole): void
    {
        ...
        $memberPermissions = Permission::whereIn('name', [
            'index-transfertCompetence',
            'show-transfertCompetence',
        ])->pluck('name')->toArray();
