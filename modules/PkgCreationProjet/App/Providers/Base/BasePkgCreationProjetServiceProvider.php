...
namespace Modules\PkgCreationProjet\App\Providers\Base;
...
class BasePkgCreationProjetServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgCreationProjet');
    ...
    protected function registerObservers()
    {
        ...
        $namespace = 'Modules\\PkgCreationProjet\\Observers\\';
        $modelNamespace = 'Modules\\PkgCreationProjet\\Models\\';
