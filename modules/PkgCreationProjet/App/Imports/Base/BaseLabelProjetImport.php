...
class BaseLabelProjetImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return LabelProjet|null
     */
    private function findExistingRecord($reference): ?LabelProjet
    {
        if($reference == null) return null;
        return LabelProjet::where('reference', $reference)->first();
    }
