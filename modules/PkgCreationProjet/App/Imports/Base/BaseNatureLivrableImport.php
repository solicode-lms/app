...
class BaseNatureLivrableImport implements ToModel, WithHeadingRow
{
    /**
     ...
     */
    private function findExistingRecord($reference): ?NatureLivrable
    {
        if($reference == null) return null;
        return NatureLivrable::where('reference', $reference)->first();
    }
