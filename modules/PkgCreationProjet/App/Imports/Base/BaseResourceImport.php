...
class BaseResourceImport implements ToModel, WithHeadingRow
{
    /**
     ...
     */
    private function findExistingRecord($reference): ?Resource
    {
        if($reference == null) return null;
        return Resource::where('reference', $reference)->first();
    }
