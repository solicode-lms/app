...
class BaseLivrableImport implements ToModel, WithHeadingRow
{
    /**
     ...
     */
    private function findExistingRecord($reference): ?Livrable
    {
        if($reference == null) return null;
        return Livrable::where('reference', $reference)->first();
    }
