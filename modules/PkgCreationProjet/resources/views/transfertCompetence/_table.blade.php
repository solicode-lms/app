...
<div class="card-body table-responsive p-0 crud-card-body" id="transfertCompetences-crud-card-body">
    <table class="table table-striped text-nowrap">
        <thead>
            <tr>
                <x-sortable-column field="competence_id" modelname="transfertCompetence" label="{{ ucfirst(__('PkgCreationProjet::transfertCompetence.competence_id')) }}" />
                ...
                <x-sortable-column field="niveau_difficulte_id" modelname="transfertCompetence" label="{{ ucfirst(__('PkgCreationProjet::transfertCompetence.niveau_difficulte_id')) }}" />
