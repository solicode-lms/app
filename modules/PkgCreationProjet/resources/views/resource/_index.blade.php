            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        @can('create-resource')
                        <button type="button" class="btn btn-info btn-sm addEntityButton" data-toggle="modal" data-target="#resourceModal">
                            <i class="fas fa-plus"></i> {{ curd_index_add_label('PkgCreationProjet::resource') }}
                        </button>
