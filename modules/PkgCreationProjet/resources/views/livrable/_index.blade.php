            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        @can('create-livrable')
                        <button type="button" class="btn btn-info btn-sm addEntityButton" data-toggle="modal" data-target="#livrableModal">
                            <i class="fas fa-plus"></i> {{ curd_index_add_label('PkgCreationProjet::livrable') }}
                        </button>
...
<div class="modal fade" id="livrableModal" tabindex="-1" role="dialog" aria-labelledby="livrableModalLabel" aria-hidden="true">
