    ...
    <div class="row">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          <div class="bulk-check">
              ...
              value="nature_livrable_id" 
              id="bulk_field_nature_livrable_id" 
      ...
      <div class="form-group col-12 col-md-12">
          ...
          <label for="description">
            {{ ucfirst(__('PkgCreationProjet::livrable.description')) }}
                ...
                id="description">
                {!! \App\Helpers\TextHelper::sanitizeTextarea(old('description', $itemLivrable->description ?? '')) !!}
                </textarea>
          @error('description')
            <div class="text-danger">{{ $message }}</div>
          @enderror
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemLivrable" field="is_affichable_seulement_par_formateur" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="is_affichable_seulement_par_formateur" 
              id="bulk_field_is_affichable_seulement_par_formateur" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
