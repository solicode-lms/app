...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemProjet" field="travail_a_faire" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-12">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="travail_a_faire" 
              id="bulk_field_travail_a_faire" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemProjet" field="critere_de_travail" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-12">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="critere_de_travail" 
              id="bulk_field_critere_de_travail" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
          <label for="critere_de_travail">
            ...
            <span class="text-danger">*</span>
                ...
                {!! \App\Helpers\TextHelper::sanitizeTextarea(old('critere_de_travail', $itemProjet->critere_de_travail ?? '')) !!}
                </textarea>
