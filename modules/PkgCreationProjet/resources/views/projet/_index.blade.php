            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        @can('create-projet')
                        <button type="button" class="btn btn-info btn-sm addEntityButton" data-toggle="modal" data-target="#projetModal">
                            <i class="fas fa-plus"></i> {{ curd_index_add_label('PkgCreationProjet::projet') }}
                        </button>
...
<div class="modal fade" id="projetModal" tabindex="-1" role="dialog" aria-labelledby="projetModalLabel" aria-hidden="true">
