...
<form 
    ...
    @if ($itemNatureLivrable->id)
        <input type="hidden" name="id" value="{{ $itemNatureLivrable->id }}">
        @method('PUT')
    @endif
    ...
    <div class="row">
        <x-form-field :defined_vars="get_defined_vars()" :entity="$itemNatureLivrable" field="nom" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemNatureLivrable" field="description" :bulkEdit="$bulkEdit">
