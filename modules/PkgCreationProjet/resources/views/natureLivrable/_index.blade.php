            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        ...
                        <button type="button" class="btn btn-info btn-sm addEntityButton" data-toggle="modal" data-target="#natureLivrableModal">
                            <i class="fas fa-plus"></i> {{ curd_index_add_label('PkgCreationProjet::natureLivrable') }}
                        </button>
...
<div class="modal fade" id="natureLivrableModal" tabindex="-1" role="dialog" aria-labelledby="natureLivrableModalLabel" aria-hidden="true">
