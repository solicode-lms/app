...
namespace Modules\PkgAutoformation\App\Providers\Base;

use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Facades\Route;
use Illuminate\Support\Facades\File;

class BasePkgAutoformationServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgAutoformation');
