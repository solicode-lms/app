...
class BaseEtatFormationImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return EtatFormation|null
     */
    private function findExistingRecord($reference): ?EtatFormation
    {
        if($reference == null) return null;
        return EtatFormation::where('reference', $reference)->first();
    }
