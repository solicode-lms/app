...
class BaseWorkflowFormationImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return WorkflowFormation|null
     */
    private function findExistingRecord($reference): ?WorkflowFormation
    {
        if($reference == null) return null;
        return WorkflowFormation::where('reference', $reference)->first();
    }
