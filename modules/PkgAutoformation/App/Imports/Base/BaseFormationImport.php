...
class BaseFormationImport implements ToModel, WithHeadingRow
{
    /**
     ...
     */
    private function findExistingRecord($reference): ?Formation
    {
        if($reference == null) return null;
        return Formation::where('reference', $reference)->first();
    }
    ...
    public function model(array $row)
    {
        ...
        return new Formation([
             ...
             'formation_officiel_id' => $values[6] ?? null,
