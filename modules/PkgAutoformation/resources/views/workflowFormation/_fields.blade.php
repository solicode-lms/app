...
<form 
    ...
    <div class="row">
        <x-form-field :entity="$itemWorkflowFormation" field="code">
...
<x-form-field :entity="$itemWorkflowFormation" field="titre">
...
<x-form-field :entity="$itemWorkflowFormation" field="sys_color_id">
...
<x-form-field :entity="$itemWorkflowFormation" field="description">
