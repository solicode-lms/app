...
<form 
    ...
    @if ($itemWorkflowFormation->id)
        @method('PUT')
    @endif
    @if ($bulkEdit && !empty($workflowFormation_ids))
    ...
    <div class="row">
        <x-form-field :entity="$itemWorkflowFormation" field="code" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemWorkflowFormation" field="titre" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemWorkflowFormation" field="sys_color_id" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemWorkflowFormation" field="description" :bulkEdit="$bulkEdit">
