...
class BaseEtatChapitreController extends AdminController
{
    ...
    public function index(Request $request) {
        ...
        $etatChapitres_params = array_merge(
            ...
            $request->except(['etatChapitres_search', 'page'])
        );
    ...
    public function create() {
        ...
        $bulkEdit = false;
        if (request()->ajax()) {
            return view('PkgAutoformation::etatChapitre._fields', compact('bulkEdit' ,'itemEtatChapitre', 'formateurs', 'sysColors', 'workflowChapitres'));
        }
        return view('PkgAutoformation::etatChapitre.create', compact('bulkEdit' ,'itemEtatChapitre', 'formateurs', 'sysColors', 'workflowChapitres'));
    }
    /**
    ...
    public function updateAttributes(Request $request)
    {
        ...
        $etatChapitreRequest = new EtatChapitreRequest();
        $fullRules = $etatChapitreRequest->rules();
        $rules = collect($fullRules)
            ->only(array_intersect(array_keys($request->all()), $updatableFields))
            ->toArray();

        // Ajout obligatoire de l'ID
        $rules['id'] = ['required', 'integer', 'exists:etat_chapitres,id'];
