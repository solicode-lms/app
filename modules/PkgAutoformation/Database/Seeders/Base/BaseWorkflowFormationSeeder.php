...
class BaseWorkflowFormationSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgAutoformation/Database/data/workflowFormations.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $workflowFormationService->updateOrCreate(["reference" => $row["reference"]], $workflowFormationData);
                } else {
                    $workflowFormationService->create($workflowFormationData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'WorkflowFormationController';
        $controllerBaseName = 'workflowFormation';
        $domainName = 'WorkflowFormation';
