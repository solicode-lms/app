...
class BaseEtatFormationSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgAutoformation/Database/data/etatFormations.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $etatFormationService->updateOrCreate(["reference" => $row["reference"]], $etatFormationData);
                } else {
                    $etatFormationService->create($etatFormationData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'EtatFormationController';
        $controllerBaseName = 'etatFormation';
        $domainName = 'EtatFormation';
