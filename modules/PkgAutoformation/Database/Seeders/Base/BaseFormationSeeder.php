...
class BaseFormationSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgAutoformation/Database/data/formations.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $formationService->updateOrCreate(["reference" => $row["reference"]], $formationData);
                } else {
                    $formationService->create($formationData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'FormationController';
        $controllerBaseName = 'formation';
