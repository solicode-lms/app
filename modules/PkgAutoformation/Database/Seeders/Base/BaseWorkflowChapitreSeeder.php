...
class BaseWorkflowChapitreSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgAutoformation/Database/data/workflowChapitres.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $workflowChapitreService->updateOrCreate(["reference" => $row["reference"]], $workflowChapitreData);
                } else {
                    $workflowChapitreService->create($workflowChapitreData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'WorkflowChapitreController';
        $controllerBaseName = 'workflowChapitre';
        $domainName = 'WorkflowChapitre';
