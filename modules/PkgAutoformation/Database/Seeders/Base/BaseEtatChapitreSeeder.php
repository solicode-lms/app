...
class BaseEtatChapitreSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgAutoformation/Database/data/etatChapitres.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $etatChapitreService->updateOrCreate(["reference" => $row["reference"]], $etatChapitreData);
                } else {
                    $etatChapitreService->create($etatChapitreData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'EtatChapitreController';
        $controllerBaseName = 'etatChapitre';
        $domainName = 'EtatChapitre';
