...
class BaseChapitreSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgAutoformation/Database/data/chapitres.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                $chapitreData =[
                    ...
                    "niveau_competence_id" => $row["niveau_competence_id"] ?? null,
                    "formateur_id" => $row["formateur_id"] ?? null,
                    "chapitre_officiel_id" => $row["chapitre_officiel_id"] ?? null,
