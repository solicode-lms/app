...
class BaseRealisationChapitreSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgAutoformation/Database/data/realisationChapitres.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                $realisationChapitreData =[
                    ...
                    "chapitre_id" => $row["chapitre_id"] ?? null,
                    "realisation_formation_id" => $row["realisation_formation_id"] ?? null,
                    "etat_chapitre_id" => $row["etat_chapitre_id"] ?? null,
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'RealisationChapitreController';
        $controllerBaseName = 'realisationChapitre';
        $domainName = 'RealisationChapitre';
