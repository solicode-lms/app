...
namespace Modules\PkgStatistiques\App\Providers\Base;
...
class BasePkgStatistiquesServiceProvider extends ServiceProvider
{
    /**
    ...
    public function register()
    {
        ...
        $namespace = 'Modules\\PkgStatistiques\\Services\\';
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgStatistiques');
    ...
    protected function registerObservers()
    {
        ...
        $namespace = 'Modules\\PkgStatistiques\\Observers\\';
        $modelNamespace = 'Modules\\PkgStatistiques\\Models\\';
