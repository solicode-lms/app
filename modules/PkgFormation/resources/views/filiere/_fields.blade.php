...
<form 
    ...
    @if ($itemFiliere->id)
        <input type="hidden" name="id" value="{{ $itemFiliere->id }}">
        @method('PUT')
    @endif
    @if ($bulkEdit && !empty($filiere_ids))
    ...
    <div class="row">
        <x-form-field :defined_vars="get_defined_vars()" :entity="$itemFiliere" field="code" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemFiliere" field="nom" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemFiliere" field="description" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-12">
          ...
          <label for="description">
            {{ ucfirst(__('PkgFormation::filiere.description')) }}
                ...
                id="description">
                {!! \App\Helpers\TextHelper::sanitizeTextarea(old('description', $itemFiliere->description ?? '')) !!}
                </textarea>
          @error('description')
            <div class="text-danger">{{ $message }}</div>
          @enderror
