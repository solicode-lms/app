...
<form 
    ...
    <div class="row">
        <x-form-field :entity="$itemFiliere" field="code" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemFiliere" field="nom" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemFiliere" field="description" :bulkEdit="$bulkEdit">
