...
<form 
    ...
    <div class="row">
        <x-form-field :entity="$itemModule" field="code">
...
<x-form-field :entity="$itemModule" field="nom">
...
<x-form-field :entity="$itemModule" field="description">
...
<x-form-field :entity="$itemModule" field="masse_horaire">
...
<x-form-field :entity="$itemModule" field="filiere_id">
