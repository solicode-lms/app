...
namespace Modules\PkgFormation\App\Providers\Base;
...
class BasePkgFormationServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgFormation');
    ...
    protected function registerObservers()
    {
        ...
        $namespace = 'Modules\\PkgFormation\\Observers\\';
        $modelNamespace = 'Modules\\PkgFormation\\Models\\';
