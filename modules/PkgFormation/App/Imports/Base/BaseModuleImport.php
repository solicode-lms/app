...
class BaseModuleImport implements ToModel, WithHeadingRow
{
    /**
     ...
     * @return Module|null
     */
    private function findExistingRecord($reference): ?Module
    {
        if($reference == null) return null;
        return Module::where('reference', $reference)->first();
    }
