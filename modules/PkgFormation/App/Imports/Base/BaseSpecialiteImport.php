...
class BaseSpecialiteImport implements ToModel, WithHeadingRow
{
    /**
     ...
     */
    private function findExistingRecord($reference): ?Specialite
    {
        if($reference == null) return null;
        return Specialite::where('reference', $reference)->first();
    }
