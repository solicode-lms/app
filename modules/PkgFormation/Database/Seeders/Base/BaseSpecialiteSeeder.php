...
class BaseSpecialiteSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgFormation/Database/data/specialites.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'SpecialiteController';
        $controllerBaseName = 'specialite';
        $domainName = 'Specialite';
