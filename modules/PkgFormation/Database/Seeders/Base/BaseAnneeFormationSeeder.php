...
class BaseAnneeFormationSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgFormation/Database/data/anneeFormations.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $anneeFormation = $anneeFormationService->updateOrCreate(["reference" => $row["reference"]], $anneeFormationData);
                } else {
                    $anneeFormation = $anneeFormationService->create($anneeFormationData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'AnneeFormationController';
        $controllerBaseName = 'anneeFormation';
        $domainName = 'AnneeFormation';
