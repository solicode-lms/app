...
class BaseFormateurController extends AdminController
{
    ...
    public function edit(string $id) {
        ...
        if (request()->ajax()) {
            return view('PkgFormation::formateur._fields', compact('itemFormateur', 'groupes', 'specialites', 'users', 'appreciations_data', 'projets_data', 'appreciations_stats', 'projets_stats', 'appreciations_filters', 'projets_filters'));
        }

        return view('PkgFormation::formateur.edit', compact('itemFormateur', 'groupes', 'specialites', 'users', 'appreciations_data', 'projets_data', 'appreciations_stats', 'projets_stats', 'appreciations_filters', 'projets_filters'));
