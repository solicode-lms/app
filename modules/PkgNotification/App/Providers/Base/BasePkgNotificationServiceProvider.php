...
namespace Modules\PkgNotification\App\Providers\Base;
...
class BasePkgNotificationServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgNotification');
    ...
    protected function registerObservers()
    {
        ...
        $namespace = 'Modules\\PkgNotification\\Observers\\';
        $modelNamespace = 'Modules\\PkgNotification\\Models\\';
