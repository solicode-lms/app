...
namespace Modules\PkgNotification\App\Imports\Base;
...
class BaseNotificationImport implements ToModel, WithHeadingRow
{
    /**
     ...
     */
    private function findExistingRecord($reference): ?Notification
    {
        if($reference == null) return null;
        return Notification::where('reference', $reference)->first();
    }
