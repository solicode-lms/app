...
namespace Modules\PkgNotification\Database\Seeders\Base;
...
class BaseNotificationSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgNotification/Database/data/notifications.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $moduleSlug = 'PkgNotification'; // Slug du module
        ...
        $controllerBaseName = 'notification';
