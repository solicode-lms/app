            ...
            <div class="row">
                ...
                <div id="card-tab-formateur" class="card card-info card-tabs card-workflow">
                    <div class="card-header d-flex justify-content-between p-0 pt-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="formateur-hasmany-tabs-home-tab" data-toggle="pill" href="#formateur-hasmany-tabs-home" role="tab" aria-controls="formateur-hasmany-tabs-home" aria-selected="true">{{__('PkgUtilisateurs::formateur.singular')}}</a>
                        </li>
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="edit-formateur-tabContent">
                            ...
                            <div class="tab-pane fade" id="formateur-hasmany-tabs-projet" role="tabpanel" aria-labelledby="formateur-hasmany-tabs-projet-tab">
                                @include('PkgCreationProjet::projet._index')
                            </div>
