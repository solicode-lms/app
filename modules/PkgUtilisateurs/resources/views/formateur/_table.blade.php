            ...
            @foreach ($data as $formateur)
                <tr>
                    ...
                    <td class="text-center">
                        @can('show-FormateurController')
                            <a href="{{ route('formateurs.show', $formateur) }}" class="btn btn-default btn-sm">
                                <i class="far fa-eye"></i>
                            </a>
                        @endcan
                        @can('edit-FormateurController')
                            <a href="{{ route('formateurs.edit', $formateur) }}" class="btn btn-sm btn-default">
                                <i class="fas fa-pen-square"></i>
                            </a>
                        @endcan
                        @can('destroy-FormateurController')
...
<div class="d-md-flex justify-content-between align-items-center p-2">
    <div class="d-flex align-items-center mb-2 ml-2 mt-2">
        @can('import-FormateurController')
        ...
        @endcan
        @can('export-FormateurController')
            <form class="">
