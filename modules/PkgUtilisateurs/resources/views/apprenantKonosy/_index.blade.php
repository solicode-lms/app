    ...
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        {{ curd_index_title('PkgUtilisateurs::apprenantKonosy') }}
                    </h1>
                </div>
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        @can('create-apprenantKonosy')
                        <button type="button" class="btn btn-info btn-sm addEntityButton" data-target="#apprenantKonosyModal">
                        ...
                        <div class="card-header col-md-12">
                            <div class="p-0">
                                <div class="input-group input-group-sm float-sm-right col-md-3 p-0">
                                    <input type="text" value="{{ $apprenantKonosy_searchQuery ?? '' }}" name="crud_search_input" id="crud_search_input"
...
<div class="modal fade crud-modal" id="apprenantKonosyModal" tabindex="-1" role="dialog" aria-labelledby="apprenantKonosyModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div id="modal-content-container" style="display: none;">
                <div class="modal-header">
                    <h5 class="modal-title" id="apprenantKonosyModalLabel"></h5>
