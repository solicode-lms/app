                ...
                <tr>
                    ...
                    <td class="text-center">
                        @can('show-apprenantKonosy')
                            <a href="{{ route('apprenantKonosies.show', $apprenantKonosy) }}" class="btn btn-default btn-sm">
                                <i class="far fa-eye"></i>
                            </a>
                        @endcan
                        @can('edit-apprenantKonosy')
                            <a href="{{ route('apprenantKonosies.edit', $apprenantKonosy) }}" class="btn btn-sm btn-default">
