            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        ...
                        <button type="button" class="btn btn-info btn-sm addEntityButton" data-toggle="modal" data-target="#nationaliteModal">
                            <i class="fas fa-plus"></i> {{ curd_index_add_label('PkgUtilisateurs::nationalite') }}
                        </button>
...
<div class="modal fade" id="nationaliteModal" tabindex="-1" role="dialog" aria-labelledby="nationaliteModalLabel" aria-hidden="true">
