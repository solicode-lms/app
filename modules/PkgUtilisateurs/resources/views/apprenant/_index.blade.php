    ...
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        {{ curd_index_title('PkgUtilisateurs::apprenant') }}
                    </h1>
                </div>
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        @can('create-apprenant')
                        <button type="button" class="btn btn-info btn-sm addEntityButton" data-toggle="modal" data-target="#apprenantModal">
                            <i class="fas fa-plus"></i> {{ curd_index_add_label('PkgUtilisateurs::apprenant') }}
                        </button>
...
<div class="modal fade" id="apprenantModal" tabindex="-1" role="dialog" aria-labelledby="apprenantModalLabel" aria-hidden="true">
