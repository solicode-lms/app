...
/**
 * Classe BaseEtatRealisationUa
 * Cette classe sert de base pour le modèle EtatRealisationUa.
 */
class BaseEtatRealisationUa extends BaseModel
{
    ...
    /**
     * Relation HasMany pour EtatRealisationUas.
     *
     * @return HasMany
     */
    public function realisationUas(): HasMany
    {
        return $this->hasMany(RealisationUa::class, 'etat_realisation_ua_id', 'id');
    }
