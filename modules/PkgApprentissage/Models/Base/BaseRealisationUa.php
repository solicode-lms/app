...
class BaseRealisationUa extends BaseModel
{
     ...
     */
    protected $fillable = [
        'unite_apprentissage_id', 'realisation_micro_competence_id', 'etat_realisation_ua_id', 'progression_cache', 'note_cache', 'bareme_cache', 'dernier_update', 'date_debut', 'date_fin', 'commentaire_formateur', 'progression_ideal_cache', 'taux_rythme_cache'
    ];
    public $manyToOne = [
        'UniteApprentissage' => [
