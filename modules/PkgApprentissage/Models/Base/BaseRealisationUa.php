...
class BaseRealisationUa extends BaseModel
{
     ...
     */
    protected $fillable = [
        'unite_apprentissage_id', 'realisation_micro_competence_id', 'etat_realisation_ua_id', 'progression_cache', 'note_cache', 'bareme_cache', 'date_debut', 'date_fin', 'dernier_update', 'commentaire_formateur', 'progression_ideal_cache', 'taux_rythme_cache'
    ];
    public $manyToOne = [
        'UniteApprentissage' => [
