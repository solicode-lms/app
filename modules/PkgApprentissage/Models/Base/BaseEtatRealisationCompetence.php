...
/**
 * Classe BaseEtatRealisationCompetence
 * Cette classe sert de base pour le modèle EtatRealisationCompetence.
 */
class BaseEtatRealisationCompetence extends BaseModel
{
    ...
    /**
     * Relation HasMany pour EtatRealisationCompetences.
     *
     * @return HasMany
     */
    public function realisationCompetences(): HasMany
    {
        return $this->hasMany(RealisationCompetence::class, 'etat_realisation_competence_id', 'id');
    }
