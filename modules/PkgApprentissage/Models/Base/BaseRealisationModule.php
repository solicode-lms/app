...
class BaseRealisationModule extends BaseModel
{
     ...
     */
    protected $fillable = [
        'module_id', 'apprenant_id', 'progression_cache', 'etat_realisation_module_id', 'note_cache', 'bareme_cache', 'dernier_update', 'bareme_non_evalue_cache', 'commentaire_formateur', 'date_debut', 'date_fin', 'progression_ideal_cache', 'taux_rythme_cache', 'pourcentage_non_valide_cache'
    ];
    public $manyToOne = [
        'Module' => [
