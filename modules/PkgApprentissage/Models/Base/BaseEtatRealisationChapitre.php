...
/**
 * Classe BaseEtatRealisationChapitre
 * Cette classe sert de base pour le modèle EtatRealisationChapitre.
 */
class BaseEtatRealisationChapitre extends BaseModel
{
    ...
    /**
     * Relation HasMany pour EtatRealisationChapitres.
     *
     * @return HasMany
     */
    public function realisationChapitres(): HasMany
    {
        return $this->hasMany(RealisationChapitre::class, 'etat_realisation_chapitre_id', 'id');
    }
