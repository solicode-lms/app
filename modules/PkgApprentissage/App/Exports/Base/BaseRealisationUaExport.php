    ...
    public function headings(): array
    {
        if ($this->format === 'csv') {
            return [
                ...
                'note_cc_cache' => 'note_cc_cache',
                'date_debut' => 'date_debut',
                'bareme_cc_cache' => 'bareme_cc_cache',
                'date_fin' => 'date_fin',
            ...
            return [
                ...
                'note_cc_cache' => __('PkgApprentissage::realisationUa.note_cc_cache'),
                'date_debut' => __('PkgApprentissage::realisationUa.date_debut'),
                'bareme_cc_cache' => __('PkgApprentissage::realisationUa.bareme_cc_cache'),
    ...
    public function collection()
    {
        return $this->data->map(function ($realisationUa) {
            return [
                ...
                'note_cc_cache' => $realisationUa->note_cc_cache,
                'date_debut' => $realisationUa->date_debut,
                'bareme_cc_cache' => $realisationUa->bareme_cc_cache,
