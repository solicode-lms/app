...
class BaseRealisationUaImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return RealisationUa|null
     */
    private function findExistingRecord($reference): ?RealisationUa
    {
        if($reference == null) return null;
        return RealisationUa::where('reference', $reference)->first();
    }
    ...
    public function model(array $row)
    {
        ...
        return new RealisationUa([
             ...
             'realisation_micro_competence_id' => $values[1] ?? null,
