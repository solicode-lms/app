...
class BaseEtatRealisationModuleImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return EtatRealisationModule|null
     */
    private function findExistingRecord($reference): ?EtatRealisationModule
    {
        if($reference == null) return null;
        return EtatRealisationModule::where('reference', $reference)->first();
    }
