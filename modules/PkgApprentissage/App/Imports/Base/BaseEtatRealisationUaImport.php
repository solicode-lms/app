...
class BaseEtatRealisationUaImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return EtatRealisationUa|null
     */
    private function findExistingRecord($reference): ?EtatRealisationUa
    {
        if($reference == null) return null;
        return EtatRealisationUa::where('reference', $reference)->first();
    }
