...
class BaseRealisationUaPrototypeImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return RealisationUaPrototype|null
     */
    private function findExistingRecord($reference): ?RealisationUaPrototype
    {
        if($reference == null) return null;
        return RealisationUaPrototype::where('reference', $reference)->first();
    }
