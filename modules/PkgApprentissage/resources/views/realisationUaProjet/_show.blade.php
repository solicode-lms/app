        ...
        <div class="card-body">
            ...
            <div class="col-12 col-md-6 col-lg-6 mb-3 px-2">
                <div class="border rounded p-2 h-100">
                  ...
                  <span>
                  @if(! is_null($itemRealisationUaProjet->note))
                  {{ number_format($itemRealisationUaProjet->note, 2, '.', '') }}
                  @else
                  —
                  @endif
                  </span>
            ...
            <div class="col-12 col-md-6 col-lg-6 mb-3 px-2">
                ...
                {{-- Affichage texte classique --}}
                @if($itemRealisationUaProjet->realisationTache)
                  {{ $itemRealisationUaProjet->realisationTache }}
                @else
                  <span class="text-muted">—</span>
                @endif
                </div>
