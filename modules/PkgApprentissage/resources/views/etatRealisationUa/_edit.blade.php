            ...
            <div class="row">
                ...
                <div id="card-tab-etatRealisationUa" class="card card-info card-tabs card-workflow">
                    <div class="card-header d-flex justify-content-between p-0 pt-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="etatRealisationUa-hasmany-tabs-realisationUa-tab" data-toggle="pill" href="#etatRealisationUa-hasmany-tabs-realisationUa" role="tab" aria-controls="etatRealisationUa-hasmany-tabs-realisationUa" aria-selected="false">{{ucfirst(__('PkgApprentissage::realisationUa.plural'))}}</a>
                        </li>
