...
<form 
    ...
    <div class="row">
        <x-form-field :entity="$itemEtatRealisationUa" field="ordre" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemEtatRealisationUa" field="nom" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemEtatRealisationUa" field="code" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemEtatRealisationUa" field="description" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemEtatRealisationUa" field="is_editable_only_by_formateur" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemEtatRealisationUa" field="sys_color_id" :bulkEdit="$bulkEdit">
