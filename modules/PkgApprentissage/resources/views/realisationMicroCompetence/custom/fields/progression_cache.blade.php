<div class="realisation-etat with-progress"
     style="--etat-color: {{ $entity->etatRealisationMicroCompetence->sysColor->hex ?? '#6c757d' }};">

    <x-badge 
        :text="$entity->etatRealisationMicroCompetence->nom" 
        :background="$entity->etatRealisationMicroCompetence->sysColor->hex ?? '#6c757d'" 
        class="badge-etat"
    />
