...
<x-form-field :entity="$itemEtatRealisationChapitre" field="code" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemEtatRealisationChapitre" field="description" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemEtatRealisationChapitre" field="is_editable_only_by_formateur" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemEtatRealisationChapitre" field="sys_color_id" :bulkEdit="$bulkEdit">
