...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemRealisationModule" field="progression_cache" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="progression_cache" 
              id="bulk_field_progression_cache" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemRealisationModule" field="etat_realisation_module_id" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="etat_realisation_module_id" 
              id="bulk_field_etat_realisation_module_id" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemRealisationModule" field="dernier_update" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="dernier_update" 
              id="bulk_field_dernier_update" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemRealisationModule" field="bareme_non_evalue_cache" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          <label for="bareme_non_evalue_cache">
            {{ ucfirst(__('PkgApprentissage::realisationModule.bareme_non_evalue_cache')) }}
            <span class="text-danger">*</span>
          </label>
              <input
        ...
        step="0.01"
        placeholder="{{ __('PkgApprentissage::realisationModule.bareme_non_evalue_cache') }}"
        value="{{ $itemRealisationModule ? number_format($itemRealisationModule->bareme_non_evalue_cache, 2, '.', '') : old('bareme_non_evalue_cache') }}">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemRealisationModule" field="commentaire_formateur" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-12">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="commentaire_formateur" 
              id="bulk_field_commentaire_formateur" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
          <label for="commentaire_formateur">
            {{ ucfirst(__('PkgApprentissage::realisationModule.commentaire_formateur')) }}
                ...
                {!! \App\Helpers\TextHelper::sanitizeTextarea(old('commentaire_formateur', $itemRealisationModule->commentaire_formateur ?? '')) !!}
                </textarea>
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemRealisationModule" field="progression_ideal_cache" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="progression_ideal_cache" 
              id="bulk_field_progression_ideal_cache" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemRealisationModule" field="taux_rythme_cache" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          <div class="bulk-check">
              ...
              class="check-input" 
              name="fields_modifiables[]" 
              value="taux_rythme_cache" 
              id="bulk_field_taux_rythme_cache" 
              title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemRealisationModule" field="pourcentage_non_valide_cache" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          <label for="pourcentage_non_valide_cache">
            {{ ucfirst(__('PkgApprentissage::realisationModule.pourcentage_non_valide_cache')) }}
            <span class="text-danger">*</span>
          </label>
              <input
        ...
        step="0.01"
        placeholder="{{ __('PkgApprentissage::realisationModule.pourcentage_non_valide_cache') }}"
        value="{{ $itemRealisationModule ? number_format($itemRealisationModule->pourcentage_non_valide_cache, 2, '.', '') : old('pourcentage_non_valide_cache') }}">
