...
<script>
    ...
    window.crudModalManagersConfig.push({
        ...
        fieldMetaUrl: '{{ route('realisationUaPrototypes.field.meta',  ['id' => ':id', 'field' => ':field']) }}',
        patchInlineUrl: '{{ route('realisationUaPrototypes.patchInline',  ['id' => ':id']) }}',
    ...
    <section id="realisationUaPrototype-crud-table" class="content crud-table">
        <div class="container-fluid">
            <div class="card card-outline card-info " id="card_crud">
                ...
                @if(!empty($realisationUaPrototypes_total) &&  $realisationUaPrototypes_total > 50)
                <div class="card-header">
