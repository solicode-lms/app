...
<div id="etatRealisationModule-crud-show">
    ...
    @endif
            ...
            @if(
                  (auth()->user()?->can('show-realisationModule') && $itemEtatRealisationModule->realisationModules->isNotEmpty())  
                  || auth()->user()?->can('create-realisationModule')
                  || (auth()->user()?->can('edit-realisationModule')  && $itemEtatRealisationModule->realisationModules->isNotEmpty() )
                  )
...
<script>
    ...
    window.showUIId = 'etatRealisationModule-crud-show';
