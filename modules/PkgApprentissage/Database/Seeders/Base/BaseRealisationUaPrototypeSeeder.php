...
class BaseRealisationUaPrototypeSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgApprentissage/Database/data/realisationUaPrototypes.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'RealisationUaPrototypeController';
        $controllerBaseName = 'realisationUaPrototype';
        $domainName = 'RealisationUaPrototype';
