...
class BaseRealisationCompetenceSeeder extends Seeder
{
    public static int $order = 95;
    ...
    {
        $filePath = base_path("modules/PkgApprentissage/Database/data/realisationCompetences.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["etat_realisation_competence_reference"])) {
                    $etat_realisation_competence_id = \Modules\PkgApprentissage\Models\EtatRealisationCompetence::where('reference', $row["etat_realisation_competence_reference"])
                        ->value('id');
                }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'RealisationCompetenceController';
        $controllerBaseName = 'realisationCompetence';
        $domainName = 'RealisationCompetence';
