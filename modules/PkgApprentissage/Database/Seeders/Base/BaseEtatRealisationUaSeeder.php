...
class BaseEtatRealisationUaSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgApprentissage/Database/data/etatRealisationUas.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'EtatRealisationUaController';
        $controllerBaseName = 'etatRealisationUa';
        $domainName = 'EtatRealisationUa';
