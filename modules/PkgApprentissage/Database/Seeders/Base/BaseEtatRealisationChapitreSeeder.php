...
class BaseEtatRealisationChapitreSeeder extends Seeder
{
    public static int $order = 81;
    ...
    {
        $filePath = base_path("modules/PkgApprentissage/Database/data/etatRealisationChapitres.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'EtatRealisationChapitreController';
        $controllerBaseName = 'etatRealisationChapitre';
        $domainName = 'EtatRealisationChapitre';
