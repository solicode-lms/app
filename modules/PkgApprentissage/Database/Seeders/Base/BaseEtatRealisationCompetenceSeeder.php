...
class BaseEtatRealisationCompetenceSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgApprentissage/Database/data/etatRealisationCompetences.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'EtatRealisationCompetenceController';
        $controllerBaseName = 'etatRealisationCompetence';
        $domainName = 'EtatRealisationCompetence';
