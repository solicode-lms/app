        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $realisationUaData =[
                        ...
                        "note_cc_cache" => isset($row["note_cc_cache"]) && $row["note_cc_cache"] !== "" ? $row["note_cc_cache"] : null,
                        "date_debut" => isset($row["date_debut"]) && $row["date_debut"] !== "" ? $row["date_debut"] : null,
                        "bareme_cc_cache" => isset($row["bareme_cc_cache"]) && $row["bareme_cc_cache"] !== "" ? $row["bareme_cc_cache"] : null,
