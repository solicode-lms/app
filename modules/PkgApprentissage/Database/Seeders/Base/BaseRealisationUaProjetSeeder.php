...
class BaseRealisationUaProjetSeeder extends Seeder
{
    public static int $order = 86;
    ...
    {
        $filePath = base_path("modules/PkgApprentissage/Database/data/realisationUaProjets.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                if (!empty($row["reference"])) {
                    $realisationUaProjetService->updateOrCreate(["reference" => $row["reference"]], $realisationUaProjetData);
                } else {
                    $realisationUaProjetService->create($realisationUaProjetData);
                }
            }
        }
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'RealisationUaProjetController';
        $controllerBaseName = 'realisationUaProjet';
        $domainName = 'RealisationUaProjet';
