...
class BaseEtatRealisationMicroCompetenceSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgApprentissage/Database/data/etatRealisationMicroCompetences.csv");
        ...
        while (($data = fgetcsv($csvFile)) !== false) {
            ...
            if ($row) {
                ...
                $etatRealisationMicroCompetenceData =[
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'EtatRealisationMicroCompetenceController';
        $controllerBaseName = 'etatRealisationMicroCompetence';
        $domainName = 'EtatRealisationMicroCompetence';
