...
class BaseEtatRealisationModuleSeeder extends Seeder
{
    public static int $order = 92;
    ...
    {
        $filePath = base_path("modules/PkgApprentissage/Database/data/etatRealisationModules.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'EtatRealisationModuleController';
        $controllerBaseName = 'etatRealisationModule';
        $domainName = 'EtatRealisationModule';
