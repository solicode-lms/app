...
namespace Modules\PkgCompetences\App\Providers\Base;
...
class BasePkgCompetencesServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgCompetences');
    ...
    protected function registerObservers()
    {
        ...
        $namespace = 'Modules\\PkgCompetences\\Observers\\';
        $modelNamespace = 'Modules\\PkgCompetences\\Models\\';
