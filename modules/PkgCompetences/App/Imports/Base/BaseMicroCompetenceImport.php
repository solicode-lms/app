...
class BaseMicroCompetenceImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return MicroCompetence|null
     */
    private function findExistingRecord($reference): ?MicroCompetence
    {
        if($reference == null) return null;
        return MicroCompetence::where('reference', $reference)->first();
    }
