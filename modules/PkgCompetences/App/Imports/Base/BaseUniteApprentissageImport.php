...
class BaseUniteApprentissageImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return UniteApprentissage|null
     */
    private function findExistingRecord($reference): ?UniteApprentissage
    {
        if($reference == null) return null;
        return UniteApprentissage::where('reference', $reference)->first();
    }
