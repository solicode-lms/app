...
class BaseUniteApprentissageController extends AdminController
{
    ...
    public function show(string $id) {
        ...
        $this->viewState->set('scope.questionLib.unite_apprentissage_id', $id);
        

        $questionLibService =  new QuestionLibService();
        $questionLibs_view_data = $questionLibService->prepareDataForIndexView();
        extract($questionLibs_view_data);

        if (request()->ajax()) {
            return view('PkgCompetences::uniteApprentissage._show', array_merge(compact('itemUniteApprentissage'),$chapitre_compact_value, $critereEvaluation_compact_value, $questionLib_compact_value));
        }

        return view('PkgCompetences::uniteApprentissage.show', array_merge(compact('itemUniteApprentissage'),$chapitre_compact_value, $critereEvaluation_compact_value, $questionLib_compact_value));
    ...
    public function edit(string $id) {
        ...
        if (request()->ajax()) {
            return view('PkgCompetences::uniteApprentissage._edit', array_merge(compact('bulkEdit' , 'itemUniteApprentissage','microCompetences'),$chapitre_compact_value, $critereEvaluation_compact_value, $questionLib_compact_value));
        }

        return view('PkgCompetences::uniteApprentissage.edit', array_merge(compact('bulkEdit' ,'itemUniteApprentissage','microCompetences'),$chapitre_compact_value, $critereEvaluation_compact_value, $questionLib_compact_value));
