...
class BaseNiveauCompetenceController extends AdminController
{
    ...
    public function export($format)
    {
        ...
        if ($format === 'csv') {
            return Excel::download(new NiveauCompetenceExport($niveauCompetences_data), 'niveauCompetence_export.csv', \Maatwebsite\Excel\Excel::CSV, ['Content-Type' => 'text/csv']);
        } elseif ($format === 'xlsx') {
            return Excel::download(new NiveauCompetenceExport($niveauCompetences_data), 'niveauCompetence_export.xlsx', \Maatwebsite\Excel\Excel::XLSX);
        } else {
