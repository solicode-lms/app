...
class BaseNiveauDifficulteSeeder extends Seeder
{
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'NiveauDifficulteController';
        $controllerBaseName = 'niveauDifficulte';
        $domainName = 'NiveauDifficulte';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Édition ' => [ 'create','store','edit','update','destroy','getNiveauDifficultes'],
            'Lecture' => ['index', 'show'],
    ...
    private function assignPermissionsToRoles(string $AdminRole, string $MembreRole): void
    {
        ...
        $memberPermissions = Permission::whereIn('name', [
            'index-niveauDifficulte',
            'show-niveauDifficulte',
        ])->pluck('name')->toArray();
