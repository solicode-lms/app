...
class BaseMicroCompetenceSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgCompetences/Database/data/microCompetences.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'MicroCompetenceController';
        $controllerBaseName = 'microCompetence';
        $domainName = 'MicroCompetence';
