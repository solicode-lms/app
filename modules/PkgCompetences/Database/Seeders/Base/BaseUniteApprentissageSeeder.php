...
class BaseUniteApprentissageSeeder extends Seeder
{
    ...
    {
        $filePath = base_path("modules/PkgCompetences/Database/data/uniteApprentissages.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'UniteApprentissageController';
        $controllerBaseName = 'uniteApprentissage';
        $domainName = 'UniteApprentissage';
