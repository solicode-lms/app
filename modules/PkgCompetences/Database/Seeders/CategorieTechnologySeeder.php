...
class CategorieTechnologySeeder extends Seeder
{
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'CategorieTechnologyController';
        $controllerBaseName = 'categorieTechnology';
        $domainName = 'CategorieTechnology';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'manager' => [ 'index','show','create','store','edit','update','destroy','getCategorieTechnologies'],
            'readOnly' => ['index', 'show'],
    ...
    private function assignPermissionsToRoles(string $AdminRole, string $MembreRole): void
    {
        ...
        $memberPermissions = Permission::whereIn('name', [
            'index-categorieTechnology',
            'show-categorieTechnology',
        ])->pluck('name')->toArray();
