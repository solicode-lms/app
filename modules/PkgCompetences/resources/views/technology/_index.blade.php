            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        ...
                        <a href="{{ route('technologies.create') }}" data-target="#technologyModal" class="btn btn-info btn-sm context-state addEntityButton">
...
<div class="modal fade crud-modal" id="technologyModal" tabindex="-1" role="dialog" aria-labelledby="technologyModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div id="modal-content-container" style="display: none;">
                <div class="modal-header">
                    <h5 class="modal-title" id="technologyModalLabel"></h5>
