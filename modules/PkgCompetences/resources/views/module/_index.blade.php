            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        @can('create-module')
                        <button type="button" class="btn btn-info btn-sm addEntityButton" data-target="#moduleModal">
...
<div class="modal fade crud-modal" id="moduleModal" tabindex="-1" role="dialog" aria-labelledby="moduleModalLabel" aria-hidden="true">
