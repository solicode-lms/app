...
<form 
    ...
    <div class="row">
        <x-form-field :entity="$itemPhaseEvaluation" field="ordre" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemPhaseEvaluation" field="code" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemPhaseEvaluation" field="libelle" :bulkEdit="$bulkEdit">

      <div class="form-group col-12 col-md-6">
          @if ($bulkEdit)
          <div class="bulk-check">
              <input type="checkbox" class="check-input" name="fields_modifiables[]" value="libelle" id="bulk_field_libelle" title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
          <label for="libelle">
...
<x-form-field :entity="$itemPhaseEvaluation" field="coefficient" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemPhaseEvaluation" field="description" :bulkEdit="$bulkEdit">
