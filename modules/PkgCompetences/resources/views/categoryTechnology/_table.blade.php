                ...
                <tr>
                    ...
                    <td class="text-center">
                        @can('show-categoryTechnology')
                            <a href="{{ route('categoryTechnologies.show', $categoryTechnology) }}" data-id="{{$categoryTechnology->id}}" class="btn btn-default btn-sm showEntity">
                                <i class="far fa-eye"></i>
                            </a>
                        @endcan
                        @can('edit-categoryTechnology')
                            <a href="{{ route('categoryTechnologies.edit', $categoryTechnology) }}" data-id="{{$categoryTechnology->id}}" class="btn btn-sm btn-default editEntity">
                                <i class="fas fa-pen-square"></i>
                            </a>
                        @endcan
                        @can('destroy-categoryTechnology')
                            <form action="{{ route('categoryTechnologies.destroy', $categoryTechnology) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
