...
<form 
    ...
    action="{{ isset($bulkEdit) && $bulkEdit ? route('categoryTechnologies.bulkUpdate') : ($itemCategoryTechnology->id ? route('categoryTechnologys.update', $itemCategoryTechnology->id) : route('categoryTechnologys.store')) }}"
    method="POST"
    novalidate > 
