...
<form 
    ...
    <div class="row">
        <x-form-field :entity="$itemNiveauCompetence" field="nom" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemNiveauCompetence" field="description" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemNiveauCompetence" field="competence_id" :bulkEdit="$bulkEdit">
