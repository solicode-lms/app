...
<form 
    ...
    <div class="row">
        <x-form-field :entity="$itemNiveauCompetence" field="nom">
...
<x-form-field :entity="$itemNiveauCompetence" field="description">
...
<x-form-field :entity="$itemNiveauCompetence" field="competence_id">
