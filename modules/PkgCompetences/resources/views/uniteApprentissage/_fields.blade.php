...
<form 
    ...
    @if ($itemUniteApprentissage->id)
        <input type="hidden" name="id" value="{{ $itemUniteApprentissage->id }}">
        @method('PUT')
    @endif
    ...
    <div class="row">
        <x-form-field :defined_vars="get_defined_vars()" :entity="$itemUniteApprentissage" field="ordre" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemUniteApprentissage" field="code" :bulkEdit="$bulkEdit">
      ...
      <div class="form-group col-12 col-md-6">
          ...
          @endif
          <label for="code">
            {{ ucfirst(__('PkgCompetences::uniteApprentissage.code')) }}
           ...
           <input
                ...
                id="code"
                placeholder="{{ __('PkgCompetences::uniteApprentissage.code') }}"
                value="{{ $itemUniteApprentissage ? $itemUniteApprentissage->code : old('code') }}">
          @error('code')
            <div class="text-danger">{{ $message }}</div>
          @enderror
      </div>
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemUniteApprentissage" field="nom" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemUniteApprentissage" field="micro_competence_id" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemUniteApprentissage" field="lien" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemUniteApprentissage" field="description" :bulkEdit="$bulkEdit">
