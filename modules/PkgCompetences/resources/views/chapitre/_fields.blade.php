...
<form 
    ...
    @if ($itemChapitre->id)
        <input type="hidden" name="id" value="{{ $itemChapitre->id }}">
        @method('PUT')
    @endif
    ...
    <div class="row">
        <x-form-field :defined_vars="get_defined_vars()" :entity="$itemChapitre" field="ordre" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemChapitre" field="code" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemChapitre" field="nom" :bulkEdit="$bulkEdit">
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemChapitre" field="duree_en_heure" :bulkEdit="$bulkEdit">

      <div class="form-group col-12 col-md-6">
          @if ($bulkEdit)
          <div class="bulk-check">
              <input {{ $canEdittache_id ? '' : 'disabled' }} type="checkbox" class="check-input" name="fields_modifiables[]" value="duree_en_heure" id="bulk_field_duree_en_heure" title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
...
<x-form-field :defined_vars="get_defined_vars()" :entity="$itemChapitre" field="isOfficiel" :bulkEdit="$bulkEdit">

      <div class="form-group col-12 col-md-6">
          @if ($bulkEdit)
          <div class="bulk-check">
              <input {{ $canEdittache_id ? '' : 'disabled' }} type="checkbox" class="check-input" name="fields_modifiables[]" value="isOfficiel" id="bulk_field_isOfficiel" title="Appliquer ce champ à tous les éléments sélectionnés" data-toggle="tooltip">
          </div>
          @endif
