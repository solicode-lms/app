    ...
    <table class="table table-striped text-nowrap" style="table-layout: fixed; width: 100%;">
        <thead style="width: 100%">
            <tr>
                ...
                <x-sortable-column :sortable="true" width="19.5"  field="nom" modelname="chapitre" label="{{ucfirst(__('PkgCompetences::chapitre.nom'))}}" />
                <x-sortable-column :sortable="true" width="19.5"  field="lien" modelname="chapitre" label="{{ucfirst(__('PkgCompetences::chapitre.lien'))}}" />
                <x-sortable-column :sortable="true" width="19.5" field="unite_apprentissage_id" modelname="chapitre" label="{{ucfirst(__('PkgCompetences::uniteApprentissage.singular'))}}" />
                <x-sortable-column :sortable="true" width="19.5" field="formateur_id" modelname="chapitre" label="{{ucfirst(__('PkgFormation::formateur.singular'))}}" />
        ...
        <tbody>
            ...
            @foreach ($chapitres_data as $chapitre)
                ...
                <tr id="chapitre-row-{{$chapitre->id}}" data-id="{{$chapitre->id}}">
                    ...
                    <td style="max-width: 19.5%;" class="{{ $isEditable ? 'editable-cell' : '' }} text-truncate" data-id="{{$chapitre->id}}" data-field="nom"  data-toggle="tooltip" title="{{ $chapitre->nom }}" >
                        {{ $chapitre->nom }}

                    </td>
                    <td style="max-width: 19.5%;" class="{{ $isEditable ? 'editable-cell' : '' }} text-truncate" data-id="{{$chapitre->id}}" data-field="lien"  data-toggle="tooltip" title="{{ $chapitre->lien }}" >
                        {{ $chapitre->lien }}

                    </td>
                    <td style="max-width: 19.5%;" class="{{ $isEditable ? 'editable-cell' : '' }} text-truncate" data-id="{{$chapitre->id}}" data-field="unite_apprentissage_id"  data-toggle="tooltip" title="{{ $chapitre->uniteApprentissage }}" >
                        {{  $chapitre->uniteApprentissage }}

                    </td>
                    <td style="max-width: 19.5%;" class="{{ $isEditable ? 'editable-cell' : '' }} text-truncate" data-id="{{$chapitre->id}}" data-field="formateur_id"  data-toggle="tooltip" title="{{ $chapitre->formateur }}" >
                        {{  $chapitre->formateur }}
