                ...
                <div id="card-tab-sessionFormation" class="card card-info card-tabs card-workflow">
                    <div class="card-header d-flex justify-content-between p-0 pt-1">
                        ...
                        <li class="nav-item">
                         ...
                         @if($itemSessionFormation->alignementUas->count() > 0 || auth()->user()?->can('create-alignementUa'))
                        <li class="nav-item">
                        ...
                        @endif
                         @if($itemSessionFormation->livrableSessions->count() > 0 || auth()->user()?->can('create-livrableSession'))
                        <li class="nav-item">
