...
<form 
    ...
    <div class="row">
        <x-form-field :entity="$itemLivrableSession" field="ordre" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemLivrableSession" field="titre" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemLivrableSession" field="description" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemLivrableSession" field="session_formation_id" :bulkEdit="$bulkEdit">
...
<x-form-field :entity="$itemLivrableSession" field="nature_livrable_id" :bulkEdit="$bulkEdit">
