...
class BaseSessionFormationImport implements ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        ...
        return new SessionFormation([
             ...
             'jour_feries_vacances' => $values[5] ?? null,
             'thematique' => $values[6] ?? null,
             'objectifs_pedagogique' => $values[7] ?? null,
             'remarques' => $values[8] ?? null,
             'titre_prototype' => $values[9] ?? null,
             'description_prototype' => $values[10] ?? null,
             'contraintes_prototype' => $values[11] ?? null,
             'titre_projet' => $values[12] ?? null,
