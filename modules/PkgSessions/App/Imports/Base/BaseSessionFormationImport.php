...
class BaseSessionFormationImport implements ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        ...
        return new SessionFormation([
             'ordre' => $values[0] ?? null,
             'titre' => $values[1] ?? null,
             'thematique' => $values[2] ?? null,
             'filiere_id' => $values[3] ?? null,
             'objectifs_pedagogique' => $values[4] ?? null,
             'titre_prototype' => $values[5] ?? null,
             'description_prototype' => $values[6] ?? null,
             'contraintes_prototype' => $values[7] ?? null,
             'titre_projet' => $values[8] ?? null,
             'description_projet' => $values[9] ?? null,
             'contraintes_projet' => $values[10] ?? null,
             'remarques' => $values[11] ?? null,
             'date_debut' => $values[12] ?? null,
             'date_fin' => $values[13] ?? null,
             'jour_feries_vacances' => $values[14] ?? null,
             'reference' => $reference,
