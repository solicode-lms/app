...
class BaseLivrableSessionImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return LivrableSession|null
     */
    private function findExistingRecord($reference): ?LivrableSession
    {
        if($reference == null) return null;
        return LivrableSession::where('reference', $reference)->first();
    }
