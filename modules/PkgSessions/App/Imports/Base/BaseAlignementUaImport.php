...
class BaseAlignementUaImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return AlignementUa|null
     */
    private function findExistingRecord($reference): ?AlignementUa
    {
        if($reference == null) return null;
        return AlignementUa::where('reference', $reference)->first();
    }
