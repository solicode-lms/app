...
class BaseAlignementUaSeeder extends Seeder
{
    public static int $order = 88;
    ...
    {
        $filePath = base_path("modules/PkgSessions/Database/data/alignementUas.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'AlignementUaController';
        $controllerBaseName = 'alignementUa';
        $domainName = 'AlignementUa';
