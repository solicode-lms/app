...
class BaseLivrableSessionSeeder extends Seeder
{
    public static int $order = 89;
    ...
    {
        $filePath = base_path("modules/PkgSessions/Database/data/livrableSessions.csv");
    ...
    public function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'LivrableSessionController';
        $controllerBaseName = 'livrableSession';
        $domainName = 'LivrableSession';
