...
namespace Modules\PkgPasserQcm\App\Providers\Base;
...
class BasePkgPasserQcmServiceProvider extends ServiceProvider
{
    /**
    ...
    public function register()
    {
        ...
        $namespace = 'Modules\\PkgPasserQcm\\Services\\';
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../../resources/views', 'PkgPasserQcm');
    ...
    protected function registerObservers()
    {
        ...
        $namespace = 'Modules\\PkgPasserQcm\\Observers\\';
        $modelNamespace = 'Modules\\PkgPasserQcm\\Models\\';
