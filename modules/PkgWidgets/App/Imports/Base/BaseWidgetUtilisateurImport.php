...
class BaseWidgetUtilisateurImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return WidgetUtilisateur|null
     */
    private function findExistingRecord($reference): ?WidgetUtilisateur
    {
        if($reference == null) return null;
        return WidgetUtilisateur::where('reference', $reference)->first();
    }
