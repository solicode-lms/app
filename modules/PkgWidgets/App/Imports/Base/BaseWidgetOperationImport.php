...
class BaseWidgetOperationImport implements ToModel, WithHeadingRow
{
    /**
     * Vérifie si un enregistrement avec la même référence existe.
     *
     * @param string $reference Référence unique de l'enregistrement.
     * @return WidgetOperation|null
     */
    private function findExistingRecord($reference): ?WidgetOperation
    {
        if($reference == null) return null;
        return WidgetOperation::where('reference', $reference)->first();
    }
