    ...
    public function headings(): array
    {
        if ($this->format === 'csv') {
            return [
                ...
                'name' => 'name',
                'label' => 'label',
                'type_reference' => 'widget_type_reference',
                'model_reference' => 'sys_model_reference',
                'operation_reference' => 'widget_operation_reference',
                'color' => 'color',
            ...
            return [
                ...
                'type_reference' => __('PkgWidgets::widgetType.singular'),
                'model_reference' => __('Core::sysModel.singular'),
                'operation_reference' => __('PkgWidgets::widgetOperation.singular'),
