...
class BaseWidgetTypeSeeder extends Seeder
{
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'WidgetTypeController';
        $controllerBaseName = 'widgetType';
        $domainName = 'WidgetType';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Afficher' => ['show'],
            'Lecture' => ['index', 'show'],
            'Édition sans Ajouter' => ['index', 'show','edit','update','destroy','getWidgetTypes','dataCalcul'],
            'Édition ' => [ 'index', 'show','create','store','edit','update','destroy','getWidgetTypes','dataCalcul'],
