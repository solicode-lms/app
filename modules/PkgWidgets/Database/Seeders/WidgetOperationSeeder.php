...
namespace Modules\PkgWidgets\Database\Seeders;
...
class WidgetOperationSeeder extends Seeder
{
    ...
    private function addDefaultControllerDomainFeatures(): void
    {
        ...
        $controllerName = 'WidgetOperationController';
        $controllerBaseName = 'widgetOperation';
        $domainName = 'WidgetOperation';

        // Permissions spécifiques pour chaque type de fonctionnalité
        $featurePermissions = [
            'Édition ' => [ 'create','store','edit','update','destroy','getWidgetOperations'],
            'Lecture' => ['index', 'show'],
    ...
    private function assignPermissionsToRoles(string $AdminRole, string $MembreRole): void
    {
        ...
        $memberPermissions = Permission::whereIn('name', [
            'index-widgetOperation',
            'show-widgetOperation',
        ])->pluck('name')->toArray();
