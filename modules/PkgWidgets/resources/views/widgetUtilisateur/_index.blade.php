...
<script>
    ...
    window.crudModalManagersConfig.push({
        ...
        canEdit: @json(Auth::user()->can('edit-widgetUtilisateur')),
    ...
    <section id="widgetUtilisateur-crud-table" class="content crud-table">
        <div class="container-fluid">
            <div class="card card-outline card-info " id="card_crud">
                        ...
                        <div class="col-sm-4">
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                <x-crud-actions
                                    ...
                                    :total="$widgetUtilisateurs_total"
                                />
                            </div>
                ...
                @if(!empty($widgetUtilisateurs_total) &&  $widgetUtilisateurs_total > 10)
                <div class="card-header">
                ...
                @section('widgetUtilisateur-crud-bulk-actions')
