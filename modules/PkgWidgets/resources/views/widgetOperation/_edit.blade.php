...
<script>
    ...
    window.editWithTabPanelManagersConfig.push({
        ...
        edit_title: '{{__("Core::msg.edit") . " : " . __("PkgWidgets::widgetOperation.singular") }} - {{ $itemWidgetOperation }}',
    });
</script>
<script>
    window.modalTitle = '{{ $itemWidgetOperation }}';
                ...
                <div id="card-tab-widgetOperation" class="card card-info card-tabs card-workflow">
                    <div class="card-header d-flex justify-content-between p-0 pt-1">
                        ...
                        <li class="nav-item">
                         ...
                         @if($itemWidgetOperation->widgets->count() > 0 || auth()->user()?->can('create-widget'))
                        <li class="nav-item">
