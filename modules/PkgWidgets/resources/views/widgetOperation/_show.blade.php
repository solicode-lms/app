...
<div id="widgetOperation-crud-show">
    ...
    @endif
            ...
            @if(
                  (auth()->user()?->can('show-widget') && $itemWidgetOperation->widgets->isNotEmpty())  
                  || auth()->user()?->can('create-widget')
                  || (auth()->user()?->can('edit-widget')  && $itemWidgetOperation->widgets->isNotEmpty() )
                  )
...
<script>
    ...
    window.showUIId = 'widgetOperation-crud-show';
