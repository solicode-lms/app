                ...
                <tr>
                    ...
                    <td class="text-center">
                        @can('show-widgetOperation')
                            <a href="{{ route('widgetOperations.show', $widgetOperation) }}" class="btn btn-default btn-sm">
                                <i class="far fa-eye"></i>
                            </a>
                        @endcan
                        @can('edit-widgetOperation')
                            <a href="{{ route('widgetOperations.edit', $widgetOperation) }}" class="btn btn-sm btn-default">
                        ...
                        @can('destroy-widgetOperation')
                            <form action="{{ route('widgetOperations.destroy', $widgetOperation) }}" method="POST" style="display: inline;">
                                ...
                                <button type="submit" class="btn btn-sm btn-danger"
                                    onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce widgetoperation ?')">
