...
<script>
    ...
    window.crudModalManagersConfig.push({
        ...
        fieldMetaUrl: '{{ route('widgetOperations.field.meta',  ['id' => ':id', 'field' => ':field']) }}',
        patchInlineUrl: '{{ route('widgetOperations.patchInline',  ['id' => ':id']) }}',
    ...
    <section id="widgetOperation-crud-table" class="content crud-table">
        <div class="container-fluid">
            <div class="card card-outline card-info " id="card_crud">
                ...
                @if(!empty($widgetOperations_total) &&  $widgetOperations_total > 10)
                <div class="card-header">
