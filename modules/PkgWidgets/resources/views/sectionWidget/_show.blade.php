...
<div id="sectionWidget-crud-show">
    ...
    @endif
            ...
            @if(
                  (auth()->user()?->can('show-widget') && $itemSectionWidget->widgets->isNotEmpty())  
                  || auth()->user()?->can('create-widget')
                  || (auth()->user()?->can('edit-widget')  && $itemSectionWidget->widgets->isNotEmpty() )
                  )
...
<script>
    ...
    window.showUIId = 'sectionWidget-crud-show';
