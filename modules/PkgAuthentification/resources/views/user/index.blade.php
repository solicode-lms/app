...
@section('title', curd_index_title('PkgAuthentification::user'))
@section('content')
    <div class="content-header">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        {{ curd_index_title('PkgAuthentification::user') }}
                    </h1>
                </div>
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        @can('create-UserController')
                            <a href="{{ route('users.create') }}" class="btn btn-info">
                                ...
                                {{ curd_index_add_label('PkgAuthentification::user') }}
                            </a>
                        @endcan
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card" id="card_crud">
                        ...
                        @include('PkgAuthentification::user._table')
                        </div>
                    </div>
                </div>
            </div>
