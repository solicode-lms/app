    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <label for="email_verified_at">
                {{ ucfirst(__('PkgBlog::user.email_verified_at')) }}
            ...
            <input
                ...
                placeholder="{{ __('Enter PkgBlog::user.email_verified_at') }}"
        ...
        <div class="form-group">
            <label for="remember_token">
                {{ ucfirst(__('PkgBlog::user.remember_token')) }}
            ...
            <input
                ...
                class="form-control"
                id="remember_token"
                placeholder="{{ __('Enter PkgBlog::user.remember_token') }}"
